...
export default class TipsUI extends UIBaseView {
	...
	constructor() {
		...
		this.tips.set2dPos(this.tips.x,1207);
	...
	public setData(data): void {
		...
		//TODO 适配
		this.tips.set2dPos(this.tips.x, ScreenAdapterTools.designHeight * 0.5);
		this.tipsbg.alpha = 0;
		...
		this.tipsbg.set2dPos(ScreenAdapterTools.width / 2 - this.tipsbg.width / 2,this.tipsbg.y);
		this.tips.set2dPos(this.tipsbg.width * 0.5,this.tips.y);
