...
export default class DailyTaskUI extends ui.gameui.task.DailyTaskUI implements IMessage {
    ...
    onClickBox(data) {
        ...
        WindowManager.OpenUI(WindowCfgs.ChapterBoxRewardUI, { shareName: ShareTvOrderFunc.SHARELINE_TASK_POINTREWARD, doubleRate: TaskFunc.taskBoxDouble, type: this.stateTab[info.id], desc: desc, reward: info.reward, thisObj: this, callBack: this.receiveReward.bind(this, info.id), params: { boxId: info.id } })
