...
export default class JumpListZhiseUI extends ui.gameui.jump.JumpListZhiseUI implements IMessage {
    ...
    touchOut(isDouble: boolean) {
        this.touchEndCode = TimerManager.instance.setTimeout(() => { this.isTouch = false }, this, 1500);
    }
    /**手指从这里抬起 */
    touchOut2(isDouble: boolean) {
        this.touchEndCode2 = TimerManager.instance.setTimeout(() => { this.isTouch2 = false }, this, 1500);
    }
    /**移除定时器 */
    clearMoveLoop() {
