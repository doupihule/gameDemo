...
export default class ResultJumpDoubleUI extends ui.gameui.jump.ResultJumpDoubleUI implements IMessage {
    ...
    touchOut(isDouble: boolean) {
        this.touchEndCode = TimerManager.instance.setTimeout(() => { this.isTouch = false }, this, 2000);
    }

    secondTouchOut() {
        this.touchSecondEndCode = TimerManager.instance.setTimeout(() => { this.isSecondTouch = false }, this, 2000);
    }
