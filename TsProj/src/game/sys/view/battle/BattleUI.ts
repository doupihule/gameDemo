...
export class BattleUI extends ui.gameui.battle.BattleUI implements IMessage {
            ...
            if (!this.controler.guideControler.checkGuide_101()) {
                ...
                if (isShowTalk != 2) {
                    ...
                    if (levelInfo.dialogue) {
                        WindowManager.OpenUI(WindowCfgs.FogNpcTalkUI, { "viewType": FogConst.VIEW_TYPE_MAIN_LEVEL, level: this.levelId });
    ...
    skillTipHideTween(data) {
        ...
        Laya.Tween.to(this.skillTipGroup, { x: ScreenAdapterTools.width, alpha: 0 }, times, null, Laya.Handler.create(this, () => {
            this.skillTipGroup.visible = false;
