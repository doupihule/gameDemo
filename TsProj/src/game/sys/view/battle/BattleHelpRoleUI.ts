...
export default class BattleHelpRoleUI extends ui.gameui.battle.BattleHelpRoleUI {
    ...
    onClickUse() {
        if (this.freeType == ShareOrTvManager.TYPE_ADV) {
            StatisticsManager.ins.onEvent(StatisticsManager.SHOWTV_ROLETRY_CLICK, { levelId: this.thisObj.levelId, roleId: this.helpRoleId });
        }
    ...
    private use() {
        if (this.freeType == ShareOrTvManager.TYPE_ADV) {
            StatisticsManager.ins.onEvent(StatisticsManager.SHOWTV_ROLETRY_FINISH, { levelId: this.thisObj.levelId, roleId: this.helpRoleId });
        } else if (this.freeType == ShareOrTvManager.TYPE_SHARE) {
            StatisticsManager.ins.onEvent(StatisticsManager.SHARE_ROLETRY_FINISH, { levelId: this.thisObj.levelId, roleId: this.helpRoleId });
        }
