...
import RolesFunc, { RoleType } from "../../func/RolesFunc";
    ...
    setRoleAni(i, x, y, viewWay, arr, txtArr, isForce = false) {
        ...
        if (item.helpRole) {
            ...
            if (type == ShareOrTvManager.TYPE_ADV) {
                StatisticsManager.ins.onEvent(StatisticsManager.SHOWTV_ROLETRY_SHOW, { levelId: this.levelId, roleId: this.helpRoleId })
            }
