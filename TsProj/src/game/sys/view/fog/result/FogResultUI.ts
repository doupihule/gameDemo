...
export default class FogResultUI extends ui.gameui.fog.FogResultUI implements IMessage {
    ...
    multiReceive() {
        ...
        if (UserInfo.isTT()) {
            ShareOrTvManager.instance.shareOrTv(ShareTvOrderFunc.SHARELINE_FOG_MULTI_RESULT, ShareOrTvManager.TYPE_SHAREVIDEO, null, this.successCall, () => { }, this, ShareOrTvManager.TYPE_SHAREVIDEO);
        } else {
