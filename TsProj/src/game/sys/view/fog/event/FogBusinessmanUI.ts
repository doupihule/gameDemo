...
import OppoGamePlatform from "../../../../../framework/platform/OppoGamePlatform";
...
export default class FogBusinessmanUI extends ui.gameui.fog.FogBusinessmanUI implements IMessage {
    ...
    onClickBuy() {
        ...
        FogServer.businessBuy({ "cost": this.costArr, "reward": [this.reward], "costAct": this.events.mobilityCost }, this.buyCallBack, this);
        //保存FogReward数据
