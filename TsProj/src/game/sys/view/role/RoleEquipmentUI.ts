...
export default class RoleEquipmentUI extends ui.gameui.role.RoleEquipmentUI implements IMessage {
    ...
    onClickAdEvo() {
        ...
        ShareOrTvManager.instance.shareOrTv(ShareTvOrderFunc.SHARELINE_EVOLUTION_FREE, ShareOrTvManager.TYPE_ADV, { id: 1, extraData: {} }, this.successCall, this.failCall, this)
    }
    successCall() {
