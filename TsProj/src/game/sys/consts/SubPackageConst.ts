...
export default class SubPackageConst {
    ...
    public static _subPackData: any = {
        ...
        [SubPackageConst.packName_atlas_source]: { path: "res/atlas/uisource/", style: SubPackageConst.PATH_STYLE_NATIVE },
        //动态分包的目录也需要在这里占一个坑
        ...
        [SubPackageConst.packName_heroIconBig]: { path: "res/atlas/heroiconbig/", style: SubPackageConst.PATH_STYLE_SUBPACK },

        [SubPackageConst.packName_fogItem]: { path: "res/atlas/uisource/fogitemicon/", style: SubPackageConst.PATH_STYLE_SUBPACK },
        [SubPackageConst.packName_expedition]: { path: "res/atlas/uisource/expedition/", style: SubPackageConst.PATH_STYLE_SUBPACK },
        [SubPackageConst.packName_equipicon]: { path: "res/atlas/uisource/equipicon/", style: SubPackageConst.PATH_STYLE_SUBPACK },
    ...
    public static spineGroupCfgs = [
        { path: 'groupSpine', name: 'group_effect_common', child: ['efect_same_born_01', 'effect_dianta_shoot_1006', 'effect_flat_skill1_aoe', 'effect_flat_skill2_aoe', 'effect_flat_skill3_aoe', 'effect_flat_skill4_hit', 'effect_geshou_skill2_hit', 'effect_huaji_attack_hit', 'effect_normal_boom', 'effect_tanya_attack_hit'] },
        ...
        { path: 'groupSpine', name: 'group_role_05', child: ['effect_longge_attack_hit', 'effect_longge_attack_self', 'role_05'] },
        { path: 'groupSpine', name: 'group_role_06', child: ['effect_digouyou_attack_self', 'role_06'] },
        { path: 'groupSpine', name: 'group_role_07', child: ['bullet_leidian_attack', 'effect_leidian_attack_buff', 'effect_leidian_attack_hit', 'role_07'] },
        { path: 'groupSpine', name: 'group_role_08', child: ['bullet_jiapanxia_attack', 'effect_jianpanxia_attack_hit', 'role_08'] },
        { path: 'groupSpine', name: 'group_role_10', child: ['effect_xiongmaoren_attack_hit', 'effect_xiongmaoren_attack_self', 'effect_xiongmaoren_skill2', 'role_10'] },
        { path: 'groupSpine', name: 'group_role_1000', child: ['bullet_jidi_attack', 'bullet_jidi_attack01', 'bullet_jidi_attack02', 'effect_jidi_attack01_hit', 'effect_jidi_attack02_hit', 'effect_jidi_attack_hit', 'effect_jidi_boom_1015', 'role_1000'] },
        { path: 'groupSpine', name: 'group_role_1001', child: ['role_1001'] },
        { path: 'groupSpine', name: 'group_role_11', child: ['effect_murcat_attack_buff', 'effect_murcat_attack_buff_1', 'effect_murcat_attack_self', 'effect_shield_buff', 'role_11'] },
        { path: 'groupSpine', name: 'group_role_12', child: ['effect_huangniao_attack_hit', 'effect_huangniao_attack_self', 'effect_huangniao_skill01_AOE', 'role_12'] },
        { path: 'groupSpine', name: 'group_role_13', child: ['effect_pipixia_attack_buff', 'effect_pipixia_attack_hit', 'role_13'] },
        { path: 'groupSpine', name: 'group_role_14', child: ['bullet_foxi_attack', 'effect_foxi_attack_buff', 'effect_foxi_attack_hit', 'effect_foxi_attack_self', 'role_14'] },
        { path: 'groupSpine', name: 'group_role_15', child: ['bullet_ningmeng_attack', 'effect_ningmeng_attack_aoe', 'effect_ningmeng_attack_buff', 'role_15'] },
        { path: 'groupSpine', name: 'group_role_16', child: ['effect_lanqiu_attack_aoe', 'effect_lanqiu_attack_aoe2'] },
        { path: 'groupSpine', name: 'group_role_17', child: ['bullet_gewala_attack_self', 'effect_gewala_attack_hit', 'effect_gewala_attack_self', 'bullet_gewala_attack_self_01', 'role_17', 'role_17_1'] },
        { path: 'groupSpine', name: 'group_role_21', child: ['bullet_996_skill01', 'effect_996_skill01_aoe', 'effect_996_skill02_aoe', 'effect_996_skill02_self', 'role_21'] },
        { path: 'groupSpine', name: 'group_role_19', child: ['role_19'] },
        { path: 'groupSpine', name: 'group_role_20', child: ['role_20', 'bullet_chigua_attack', 'effect_chigua_attack_self'] }
