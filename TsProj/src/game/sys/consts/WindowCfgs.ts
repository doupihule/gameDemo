...
import FogStartWarUI from "../view/fog/FogStartWarUI";
import FogResultRewardUI from "../view/fog/result/FogResultRewardUI";
	...
	static get windowcfgs() {
		if (!this._windowcfgs) {
			this._windowcfgs = {
				...
				[WindowCfgs.TestOpListUI]: {
					modal: 1,
					path: TestOpListUI,
					parent: WindowCfgs.HIGHLAYER,
					autoClose: true,
					modalAlpha: 0.01,
					group: ["gameui/test/TestOpList.scene"],
				...
				[WindowCfgs.ResultJumpDoubleUI]: {
					modal: 1,
					path: ResultJumpDoubleUI,
					modalAlpha: 0.01,
					group: ["gameui/jump/ResultJumpDouble.scene",],
					subPackage: ["uisource", "atlas_source"]
				},
				...
				[WindowCfgs.BattleResultUI]: {
					modal: 1,
					path: BattleResultUI,
					modalAlpha: 0.8,
					group: ["gameui/battle/BattleResult.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.RoleInfoUI]: {
					modal: 1,
					path: RoleInfoUI,
					modalAlpha: 0,
					group: ["gameui/role/RoleInfo.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FlatItemUI]: {
					modal: 1,
					path: FlatItemUI,
					modalAlpha: 0,
					group: ["gameui/main/FlatItem.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.HomeUpgradeUI]: {
					modal: 1,
					path: HomeUpgradeUI,
					modalAlpha: 0.6,
					group: ["gameui/role/HomeUpgrade.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.RoleInLineUI]: {
					modal: 1,
					path: RoleInLineUI,
					modalAlpha: 0.9,
					group: ["gameui/roleLine/RoleInLine.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.RoleItemUI]: {
					modal: 1,
					path: RoleItemUI,
					modalAlpha: 0,
					group: ["gameui/roleLine/RoleItem.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.RoleLineItemUI]: {
					modal: 1,
					path: RoleLineItemUI,
					modalAlpha: 0,
					group: ["gameui/roleLine/RoleLineItem.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.SevenDaysUI]: {
					modal: 1,
					path: SevenDaysUI,
					parent: WindowCfgs.HIGHLAYER,
					modalAlpha: 0.6,
					group: ["gameui/main/SevenDays.scene"],
					subPackage: ["uisource", "atlas_source", SubPackageConst.packName_equipicon]
				},
				[WindowCfgs.BattleDetailUI]: {
					path: BattleDetailUI,
					group: ["gameui/battle/BattleDetail.scene"],
					subPackage: ["uisource", "atlas_source"],
					full: true
				},
				[WindowCfgs.TurnableUI]: {
					modal: 1,
					path: TurnableUI,
					modalAlpha: 0.6,
					group: ["gameui/main/Turnable.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.BoxInfoUI]: {
					modal: 1,
					path: BoxInfoUI,
					modalAlpha: 0.6,
					group: ["gameui/main/BoxInfo.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FreeResourceUI]: {
					modal: 1,
					path: FreeResourceUI,
					modalAlpha: 0.6,
					group: ["gameui/main/FreeResource.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.GuideUI]: {
					modal: 1,
					path: GuideUI,
					modalAlpha: 0.01,
					group: ["gameui/guide/Guide.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.AirDropDetailUI]: {
					modal: 1,
					path: AirDropDetailUI,
					modalAlpha: 0.6,
					group: ["gameui/main/AirDropDetail.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.OfflineIncomeUI]: {
					modal: 1,
					path: OfflineIncomeUI,
					parent: WindowCfgs.HIGHLAYER,
					modalAlpha: 0.6,
					group: ["gameui/main/OfflineIncome.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.ComRewardDoubleUI]: {
					modal: 1,
					path: ComRewardDoubleUI,
					parent: WindowCfgs.HIGHLAYER,
					modalAlpha: 0.6,
					group: ["gameui/common/ComRewardDouble.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.UnlockRoleUI]: {
					modal: 1,
					path: UnlockRoleUI,
					modalAlpha: 0.8,
					group: ["gameui/role/UnlockRole.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.BattleFullEnergyUI]: {
					modal: 1,
					path: BattleFullEnergyUI,
					modalAlpha: 0.6,
					group: ["gameui/battle/BattleFullEnergy.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.DailyGoldUI]: {
					modal: 1,
					path: DailyGoldUI,
					modalAlpha: 0.6,
					group: ["gameui/main/DailyGold.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.InviteUI]: {
					modal: 1,
					path: InviteUI,
					modalAlpha: 0.6,
					group: ["gameui/share/Invite.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.InviteListUI]: {
					modal: 1,
					path: InviteListUI,
					modalAlpha: 0,
					group: ["gameui/share/InviteList.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.RoleDetailUI]: {
					modal: 1,
					path: RoleDetailUI,
					modalAlpha: 0.6,
					group: ["gameui/role/RoleDetail.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.RoleEquipmentUI]: {
					modal: 1,
					path: RoleEquipmentUI,
					modalAlpha: 0,
					group: ["gameui/role/RoleEquipment.scene"],
					subPackage: ["uisource", "atlas_source", SubPackageConst.packName_equipicon]
				},
				[WindowCfgs.EquipItemUI]: {
					modal: 1,
					path: EquipItemUI,
					modalAlpha: 0,
					group: ["gameui/role/EquipItem.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.EquipComposeUI]: {
					modal: 1,
					path: EquipComposeUI,
					modalAlpha: 0.6,
					group: ["gameui/role/EquipCompose.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.EvoPreviewUI]: {
					modal: 1,
					path: EvoPreviewUI,
					modalAlpha: 0.6,
					group: ["gameui/role/EvoPreview.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.EvoRewardUI]: {
					modal: 1,
					path: EvoRewardUI,
					modalAlpha: 0.8,
					group: ["gameui/role/EvoReward.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.EquipPieceGetUI]: {
					modal: 1,
					path: EquipPieceGetUI,
					modalAlpha: 0.6,
					group: ["gameui/shop/EquipPieceGet.scene"],
					subPackage: ["uisource", "atlas_source", SubPackageConst.packName_equipicon]
				},
				[WindowCfgs.RoleBarrageUI]: {
					modal: 1,
					path: RoleBarrageUI,
					modalAlpha: 0.9,
					group: ["gameui/role/RoleBarrage.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.CartoonPicUI]: {
					path: CartoonPicUI,
					group: ["gameui/cartoon/CartoonPic.scene"],
					subPackage: ["uisource", "atlas_source"],
					full: true
				},
				[WindowCfgs.FogCartoonPicUI]: {
					path: FogCartoonPicUI,
					group: ["gameui/cartoon/FogCartoonPic.scene"],
					subPackage: ["uisource", "atlas_source", SubPackageConst.packName_expedition],
					full: true
				},
				[WindowCfgs.FogInitRoleUI]: {
					modal: 1,
					path: FogInitRoleUI,
					modalAlpha: 0.7,
					group: ["gameui/fog/FogInitRole.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogRoleItemUI]: {
					modal: 1,
					path: FogRoleItemUI,
					modalAlpha: 0,
					group: ["gameui/fog/FogRoleItem.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogMainUI]: {
					modal: 1,
					path: FogMainUI,
					modalAlpha: 0.01,
					group: ["gameui/fog/FogMain.scene"],
					subPackage: ["uisource", "atlas_source", SubPackageConst.packName_expedition, SubPackageConst.packName_fogItem],
					full: true
				},
				[WindowCfgs.FogVideoEnterUI]: {
					modal: 1,
					path: FogVideoEnterUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogVideoEnter.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogBusUI]: {
					modal: 1,
					path: FogBusUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogBus.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogBagItemUI]: {
					modal: 0,
					path: FogBagItemUI,
					modalAlpha: 0,
					group: ["gameui/fog/FogBagItem.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogBagUI]: {
					modal: 1,
					path: FogBagUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogBag.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogBagItemDetailUI]: {
					modal: 1,
					path: FogBagItemDetailUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogBagItemDetail.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogMultiRewardUI]: {
					modal: 1,
					path: FogMultiRewardUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogMultiReward.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogShopUI]: {
					modal: 1,
					path: FogShopUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogShop.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogBusinessmanUI]: {
					modal: 1,
					path: FogBusinessmanUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogBusinessman.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogComRewardUI]: {
					modal: 1,
					path: FogComRewardUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogComReward.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogChooseUI]: {
					modal: 1,
					path: FogChooseUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogChoose.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogAnswerUI]: {
					modal: 1,
					path: FogAnswerUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogAnswer.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogHandinUI]: {
					modal: 1,
					path: FogHandinUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogHandin.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogBoxUI]: {
					modal: 1,
					path: FogBoxUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogBox.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogBagItemFullLevelUI]: {
					modal: 1,
					path: FogBagItemFullLevelUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogBagItemFullLevel.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogFreeActUI]: {
					modal: 1,
					path: FogFreeActUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogFreeAct.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogRoleLineItemUI]: {
					modal: 1,
					path: FogRoleLineItemUI,
					modalAlpha: 0,
					group: ["gameui/fog/FogRoleLineItem.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogUserRoleUI]: {
					modal: 1,
					path: FogUserRoleUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogUserRole.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogObstacleUI]: {
					modal: 1,
					path: FogObstacleUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogObstacle.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogNpcTalkUI]: {
					modal: 1,
					path: FogNpcTalkUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogNpcTalk.scene"],
					subPackage: ["uisource", "atlas_source", SubPackageConst.packName_heroIconBig]
				},
				[WindowCfgs.FogDoorUI]: {
					modal: 1,
					path: FogDoorUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogDoor.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogTipUI]: {
					modal: 1,
					path: FogTipUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogTip.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogStartWarUI]: {
					modal: 1,
					path: FogStartWarUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogStartWar.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogResultRewardUI]: {
					modal: 1,
					path: FogResultRewardUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogResultReward.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogResultUI]: {
					modal: 1,
					path: FogResultUI,
					modalAlpha: 0.7,
					group: ["gameui/fog/FogResult.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogRewardItemUI]: {
					modal: 1,
					path: FogRewardItemUI,
					modalAlpha: 0,
					group: ["gameui/fog/FogRewardItem.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogShopItemDetailUI]: {
					modal: 1,
					path: FogShopItemDetailUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogShopItemDetail.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogBattleStartAlertUI]: {
					modal: 1,
					path: FogBattleStartAlertUI,
					modalAlpha: 0.6,
					group: ["gameui/fog/FogBattleStartAlert.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCommonCfgs.ChangeDataView]: {
					modal: 1,
					path: ChangeDataUI,
					modalAlpha: 0.01,
					group: ["gameui/changeData/ChangeData.scene"]
				},
				[WindowCfgs.SettingUI]: {
					modal: 1,
					path: SettingUI,
					modalAlpha: 0.6,
					group: ["gameui/main/Setting.scene"]
				},
				[WindowCfgs.ChapterListUI]: {
					path: ChapterListUI,
					group: ["gameui/chapter/ChapterList.scene"],
					full: true
				},
				[WindowCfgs.ChapterMapUI]: {
					path: ChapterMapUI,
					group: ["gameui/chapter/ChapterMap.scene"],
					subPackage: ["uisource", "atlas_source"],
					full: true
				},
				[WindowCfgs.ChapterBoxRewardUI]: {
					modal: 1,
					path: ChapterBoxRewardUI,
					modalAlpha: 0.6,
					group: ["gameui/chapter/ChapterBoxReward.scene"]
				},
				[WindowCfgs.ChapterBoxDoubleUI]: {
					modal: 1,
					path: ChapterBoxDoubleUI,
					modalAlpha: 0.6,
					group: ["gameui/chapter/ChapterBoxDouble.scene"]
				},
				...
				[WindowCfgs.TaskDoubleRewardUI]: {
					modal: 1,
					modalAlpha: 0.6,
					path: TaskDoubleRewardUI,
					group: ["gameui/task/TaskDoubleReward.scene"]
				},
				[WindowCfgs.ChatDetailUI]: {
					modal: 1,
					modalAlpha: 0.6,
					path: ChatDetailUI,
					group: ["gameui/task/ChatDetail.scene"]
				},
				...
				[WindowCfgs.MainJumpKariquUI]: {
					modal: 1,
					path: MainJumpKariquUI,
					modalAlpha: 0.5,
					group: ["gameui/jump/MainJumpKariqu.scene"],
					subPackage: ["uisource", "atlas_source"]
				},
				[WindowCfgs.FogBattleReviveUI]: {
					modal: 1,
					modalAlpha: 0.6,
					path: FogBattleReviveUI,
					group: ["gameui/fog/FogBattleRevive.scene"]
				},
				[WindowCfgs.BattleReviveUI]: {
					modal: 1,
					modalAlpha: 0.6,
					path: BattleReviveUI,
					group: ["gameui/battle/BattleRevive.scene"]
				},
				[WindowCfgs.OfflineRewardDoubleUI]: {
					modal: 1,
					modalAlpha: 0.6,
					path: OfflineRewardDoubleUI,
					group: ["gameui/main/OfflineRewardDouble.scene"]
				},
				[WindowCfgs.BattleUseSkillUI]: {
					modal: 1,
					modalAlpha: 0.6,
					path: BattleUseSkillUI,
					group: ["gameui/battle/BattleUseSkill.scene"]
				},
				[WindowCfgs.BattleHelpRoleUI]: {
					modal: 1,
					modalAlpha: 0.6,
					path: BattleHelpRoleUI,
					group: ["gameui/battle/BattleHelpRole.scene"]
				},
				[WindowCfgs.MainShopUI]: {
					path: MainShopUI,
					group: ["gameui/shop/MainShop.scene"],
					subPackage: ["uisource", "atlas_source", SubPackageConst.packName_equipicon]
				},
				...
				[WindowCfgs.WorkRoleUI]: {
					path: WorkRoleUI,
					group: ["gameui/work/WorkRole.scene", "gameui/work/WorkRoleItem.scene", "gameui/work/WorkInfoItem.scene"]
				},
