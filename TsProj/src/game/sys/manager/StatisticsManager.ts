...
export default class StatisticsManager {
	...
	// -----------------------------------------------------视频相关----------------------------------------------------	
	static SHOWTV_PLANTSUCEEDNUB = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 1,
		name: "showTv_LuckyRewardNub_finish"
	}//幸运转盘看视频成功
	static SHOWTV_PLANT_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 1.1,
		name: "showTv_LuckyRewardNub_show"
	}//幸运转盘视频展示
	static SHOWTV_PLANT_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 1.2,
		name: "showTv_LuckyRewardNub_click"
	}//幸运转盘抽奖点击

	static SHOWTV_BATTLEVICTORY_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 2,
		name: "showTv_BattleVictory_finish"
	}//战斗结束视频翻倍成功
	static SHOWTV_BATTLEVICTORY_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 2.1,
		name: "showTv_BattleVictory_show"
	}//战斗结束视频翻倍展示
	static SHOWTV_BATTLEVICTORY_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 2.2,
		name: "showTv_BattleVictory_click"
	}//战斗结束视频翻倍点击

	static SHOWTV_NOPOWERSUCEEDNUB = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 3,
		name: "showTv_PowerRecovery_finish"
	}//体力不足时视频加体力次数
	static SHOWTV_NOPOWER_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 3.1,
		name: "showTv_PowerRecovery_show"
	}//体力不足时视频加体力次数
	static SHOWTV_NOPOWER_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 3.2,
		name: "showTv_PowerRecovery_click"
	}//体力不足时视频加体力次数
	...
	static SHOWTV_OFFLINECOIN_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 5,
		name: "showTv_offlineCoin_finish"
	}//离线翻倍看视频播放完成次数/人数
	static SHOWTV_OFFLINECOIN_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 5.1,
		name: "showTv_offlineCoin_show"
	}//离线翻倍看视频战刺次数/人数
	static SHOWTV_OFFLINECOIN_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 5.2,
		name: "showTv_offlineCoin_click"
	}//离线翻倍看视频点击次数/人数

	static SHOWTV_UNLOCKROLE_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 6,
		name: "showTv_unlockRole_finish"
	}//解锁角色看视频播放完成次数/人数
	static SHOWTV_UNLOCKROLE_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 6.1,
		name: "showTv_unlockRole_show"
	}//解锁角色看视频战刺次数/人数
	static SHOWTV_UNLOCKROLE_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 6.2,
		name: "showTv_unlockRole_click"
	}//解锁角色看视频点击次数/人数

	static SHOWTV_BATTLEADDTION_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 7,
		name: "showTv_battleAddtion_finish"
	}//豪华开局看视频播放完成次数/人数
	static SHOWTV_BATTLEADDTION_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 7.1,
		name: "showTv_battleAddtion_show"
	}//豪华开局看视频战刺次数/人数
	static SHOWTV_BATTLEADDTION_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 7.2,
		name: "showTv_battleAddtion_click"
	}//豪华开局看视频点击次数/人数
	...
	static SHOWTV_UNLOCKROLEREWARD_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 10,
		name: "showTv_unlockRoleReward_finish"
	}//解锁角色奖励看视频播放完成次数/人数
	static SHOWTV_UNLOCKROLEREWARD_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 10.1,
		name: "showTv_unlockRoleReward_show"
	}//解锁角色奖励看视频战刺次数/人数
	static SHOWTV_UNLOCKROLEREWARD_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 10.2,
		name: "showTv_unlockRoleReward_click"
	}//解锁角色奖励看视频点击次数/人数

	static SHOWTV_ROLEEVO_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 11,
		name: "showTv_roleEvolution_finish"
	}//角色进化看视频成功次数/人数
	static SHOWTV_ROLEEVO_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 11.1,
		name: "showTv_roleEvolution_show"
	}
	static SHOWTV_ROLEEVO_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 11.2,
		name: "showTv_roleEvolution_click"
	}

	static SHOWTV_VIDEOPIECE_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 12,
		name: "showTv_videoLottery_finish"
	}//视频抽装备看视频播放完成次数
	static SHOWTV_VIDEOPIECE_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 12.1,
		name: "showTv_videoLottery_show"
	}//视频抽装备看视频展示次数
	static SHOWTV_VIDEOPIECE_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 12.2,
		name: "showTv_videoLottery_click"
	}//视频抽装备看视频点击次数

	static SHOWTV_ROLEVOREWARD_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 13,
		name: "showTv_evolutionRoleReward_finish"
	}//角色进化奖励看视频播放完成次数
	static SHOWTV_ROLEVOREWARD_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 13.1,
		name: "showTv_evolutionRoleReward_show"
	}//角色进化奖励看视频展示次数
	static SHOWTV_ROLEVOREWARD_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 13.2,
		name: "showTv_evolutionRoleReward_click"
	}//角色进化奖励看视频点击次数

	static SHOWTV_VIDEOPIECE_REWARD_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 14,
		name: "showTv_videoLotteryReward_finish"
	}//抽碎片双倍
	static SHOWTV_VIDEOPIECE_REWARD_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 14.1,
		name: "showTv_videoLotteryReward_show"
	}//抽碎片双倍
	static SHOWTV_VIDEOPIECE_REWARD_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 14.2,
		name: "showTv_videoLotteryReward_click"
	}//抽碎片双倍


	static SHOWTV_FOG_STARTROLE_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 15,
		name: "showTv_fog_startRole_finish"
	}//迷雾街区获得额外初始角色-视频播放完成次数/人数
	static SHOWTV_FOG_STARTROLE_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 15.1,
		name: "showTv_fog_startRole_show"
	}//迷雾街区获得额外初始角色-展示次数/人数
	static SHOWTV_FOG_STARTROLE_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 15.2,
		name: "showTv_fog_startRole_click"
	}//迷雾街区获得额外初始角色-点击次数/人数


	static SHOWTV_FOG_MOBILITYRECOVERY_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 16,
		name: "showTv_fog_mobilityRecovery_finish"
	}//迷雾街区恢复行动力看视频播放完成次数/人数
	static SHOWTV_FOG_MOBILITYRECOVERY_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 16.1,
		name: "showTv_fog_mobilityRecovery_show"
	}//迷雾街区恢复行动力看视频展示次数/人数
	static SHOWTV_FOG_MOBILITYRECOVERY_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 16.2,
		name: "showTv_fog_mobilityRecovery_click"
	}//迷雾街区恢复行动力看视频点击次数/人数

	static SHOWTV_FOG_SETTLEMANT_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 17,
		name: "showTv_fog_settlement_finish"
	}//迷雾街区结算翻倍看视频播放完成次数/人数
	static SHOWTV_FOG_SETTLEMANT_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 17.1,
		name: "showTv_fog_settlement_show"
	}//迷雾街区结算翻倍看视频展示次数/人数
	static SHOWTV_FOG_SETTLEMANT_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 17.2,
		name: "showTv_fog_settlement_click"
	}//迷雾街区结算翻倍看视频点击次数/人数


	static SHOWTV_FOG_SHOPREFRESH_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 18,
		name: "showTv_fog_shopRefresh_finish"
	}//迷雾街区商店刷新看视频播放完成次数/人数
	static SHOWTV_FOG_SHOPREFRESH_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 18.1,
		name: "showTv_fog_shopRefresh_show"
	}//迷雾街区商店刷新看视频展示次数/人数
	static SHOWTV_FOG_SHOPREFRESH_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 18.2,
		name: "showTv_fog_shopRefresh_click"
	}//迷雾街区商店刷新看视频点击次数/人数


	static SHOWTV_FOG_CHOOSE_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 19,
		name: "showTv_fog_choose_finish"
	}//迷雾街区2选1奖励看视频播放完成次数/人数
	static SHOWTV_FOG_CHOOSE_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 19.1,
		name: "showTv_fog_choose_show"
	}//迷雾街区2选1奖励看视频展示次数/人数
	static SHOWTV_FOG_CHOOSE_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 19.2,
		name: "showTv_fog_choose_click"
	}//迷雾街区2选1奖励看视频点击次数/人数

	static SHOWTV_FOG_BROKENROAD_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 20,
		name: "showTv_fog_brokenRoad_finish"
	}//迷雾街区坏路事件看视频播放完成次数/人数
	static SHOWTV_FOG_BROKENROAD_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 20.1,
		name: "showTv_fog_brokenRoad_show"
	}//迷雾街区坏路事件看视频展示次数/人数
	static SHOWTV_FOG_BROKENROAD_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 20.2,
		name: "showTv_fog_brokenRoad_click"
	}//迷雾街区坏路事件看视频点击次数/人数

	static SHOWTV_FOG_BATTLE_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 21,
		name: "showTv_fog_battle_finish"
	}//迷雾街区战斗胜利翻倍看视频播放完成次数/人数
	static SHOWTV_FOG_BATTLE_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 21.1,
		name: "showTv_fog_battle_show"
	}//迷雾街区战斗胜利翻倍看视频展示次数/人数
	static SHOWTV_FOG_BATTLE_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 21.2,
		name: "showTv_fog_battle_click"
	}//迷雾街区战斗胜利翻倍看视频点击次数/人数

	static SHOWTV_FOG_REMOVEBLOCK_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 22,
		name: "showTv_fog_removeBlock_finish"
	}//迷雾街区移除障碍物事件看视频播放完成次数/人数
	static SHOWTV_FOG_REMOVEBLOCK_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 22.1,
		name: "showTv_fog_removeBlock_show"
	}//迷雾街区移除障碍物事件看视频展示次数/人数
	static SHOWTV_FOG_REMOVEBLOCK_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 22.2,
		name: "showTv_fog_removeBlock_click"
	}//迷雾街区移除障碍物事件看视频点击次数/人数

	static SHOWTV_FOG_START_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 23,
		name: "showTv_fog_start_finish"
	}//迷雾街区看视频开始播放完成次数/人数
	static SHOWTV_FOG_START_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 23.1,
		name: "showTv_fog_start_show"
	}//迷雾街区看视频开始展示次数/人数
	static SHOWTV_FOG_START_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 23.2,
		name: "showTv_fog_start_click"
	}//迷雾街区看视频开始点击次数/人数

	static SHOWTV_FOG_JITANG_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 24,
		name: "showTv_fog_jitang_finish"
	}//迷雾街区心灵鸡汤视频播放完成次数/人数
	static SHOWTV_FOG_JITANG_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 24,
		name: "showTv_fog_jitang_show"
	}//迷雾街区心灵鸡汤视频展示次数/人数
	static SHOWTV_FOG_JITANG_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 24,
		name: "showTv_fog_jitang_click"
	}//迷雾街区心灵鸡汤视频点击次数/人数


	static SHOWTV_CHAPTERBOX_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 25,
		name: "showTv_chapterbox_finish"
	}//章节宝箱视频播放完成次数/人数
	static SHOWTV_CHAPTERBOX_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 25.1,
		name: "showTv_chapterbox_show"
	}//章节宝箱视频展示次数/人数
	static SHOWTV_CHAPTERBOX_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 25.2,
		name: "showTv_chapterbox_click"
	}//章节宝箱视频点击次数/人数

	static SHOWTV_TASKREWARD_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 26,
		name: "showTv_taskreward_finish"
	}//任务奖励视频播放完成次数/人数
	static SHOWTV_TASKREWARD_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 26.1,
		name: "showTv_taskreward_show"
	}//任务奖励视频展示次数/人数
	static SHOWTV_TASKREWARD_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 26.2,
		name: "showTv_taskreward_click"
	}//任务奖励视频点击次数/人数
	...
	static SHOWTV_FOG_RANDROLE_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 28,
		name: "showTv_fog_randRole_finish"
	}//迷雾街区战斗中随机获得角色视频播放完成次数/人数
	static SHOWTV_FOG_RANDROLE_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 28.1,
		name: "showTv_fog_randRole_show"
	}//迷雾街区战斗中随机获得角色展示次数/人数
	static SHOWTV_FOG_RANDROLE_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 28.2,
		name: "showTv_fog_randRole_click"
	}//迷雾街区战斗中随机获得角色点击次数/人数

	static SHOWTV_FOG_REVIVE_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 29,
		name: "showTv_fog_resurrection_finish"
	}//迷雾街区战败复活视频播放完成次数/人数
	static SHOWTV_FOG_REVIVE_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 29.1,
		name: "showTv_fog_resurrection_show"
	}//迷雾街区战败复活视频展示次数/人数
	static SHOWTV_FOG_REVIVE_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 29.2,
		name: "showTv_fog_resurrection_click"
	}//迷雾街区战败复活视频点击次数/人数

	static SHOWTV_FOG_QUESTION_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 30,
		name: "showTv_fog_question_finish"
	}//迷雾街区答题事件视频播放完成次数/人数
	static SHOWTV_FOG_QUESTION_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 30.1,
		name: "showTv_fog_question_show"
	}//迷雾街区答题事件视频展示次数/人数
	static SHOWTV_FOG_QUESTION_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 30.2,
		name: "showTv_fog_question_click"
	}//迷雾街区答题事件视频点击次数/人数

	static SHOWTV_LEVELOVERTIME_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 31,
		name: "showTv_levelOvertime_finish"
	}//关卡超时复活视频播放完成次数/人数
	static SHOWTV_LEVELOVERTIME_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 31.1,
		name: "showTv_levelOvertime_show"
	}//关卡超时复活视频展示次数/人数
	static SHOWTV_LEVELOVERTIME_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 31.2,
		name: "showTv_levelOvertime_click"
	}//关卡超时复活视频点击次数/人数

	static SHOWTV_LEVELFAIL_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 32,
		name: "showTv_levelFail_finish"
	}//关卡战败复活视频播放完成次数/人数
	static SHOWTV_LEVELFAIL_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 32.1,
		name: "showTv_levelFail_show"
	}//关卡战败复活视频展示次数/人数
	static SHOWTV_LEVELFAIL_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 32.2,
		name: "showTv_levelFail_click"
	}//关卡战败复活视频点击次数/人数

	static SHOWTV_LEVELSKILL_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 33,
		name: "showTv_levelSkill_finish"
	}//关卡技能释放视频播放完成次数/人数
	static SHOWTV_LEVELSKILL_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 33.1,
		name: "showTv_levelSkill_show"
	}//关卡技能释放视频播放展示次数/人数
	static SHOWTV_LEVELSKILL_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 33.2,
		name: "showTv_levelSkill_click"
	}//关卡技能释放视频播放点击次数/人数
	...
	static SHOWTV_SHOPREFRESH_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 35,
		name: "showTv_shopRefresh_finish"
	}//商店刷新视频播放完成次数/人数
	static SHOWTV_SHOPREFRESH_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 35.1,
		name: "showTv_shopRefresh_show"
	}//商店刷新视频展示次数/人数
	static SHOWTV_SHOPREFRESH_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 35.2,
		name: "showTv_shopRefresh_click"
	}//商店刷新视频点击次数/人数

	static SHOWTV_SHOPVIDEOBUY_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 36,
		name: "showTv_shopVideoBuy_finish"
	}//商店视频购买完成次数/人数
	static SHOWTV_SHOPVIDEOBUY_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 36.1,
		name: "showTv_shopVideoBuy_show"
	}//商店视频购买展示次数/人数
	static SHOWTV_SHOPVIDEOBUY_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 36.2,
		name: "showTv_shopVideoBuy_click"
	}//商店视频购买点击次数/人数

	static SHOWTV_WORKFRESH_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 37,
		name: "showTv_workRefresh_finish"
	}//工作刷新视频完成次数/人数
	static SHOWTV_WORKFRESH_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 37.1,
		name: "showTv_workRefresh_show"
	}//工作刷新视频展示次数/人数
	static SHOWTV_WORKFRESH_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 37.2,
		name: "showTv_workRefresh_click"
	}//工作刷新视频点击次数/人数

	static SHOWTV_WORKQUICK_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 38,
		name: "showTv_workQuickComplete_finish"
	}//工作快速完成视频完成次数/人数
	static SHOWTV_WORKQUICK_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 38.1,
		name: "showTv_workQuickComplete_show"
	}//工作快速完成视频展示次数/人数
	static SHOWTV_WORKQUICK_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 38.2,
		name: "showTv_workQuickComplete_click"
	}//工作快速完成视频点击次数/人数

	static SHOWTV_COMPANYUP_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 39,
		name: "showTv_companyUpdate_finish"
	}//工作快速完成视频完成次数/人数
	static SHOWTV_COMPANYUP_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 39.1,
		name: "showTv_companyUpdate_show"
	}//公司升级视频展示次数/人数
	static SHOWTV_COMPANYUP_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 39.2,
		name: "showTv_companyUpdate_click"
	}//公司升级视频点击次数/人数

	static SHOWTV_GIFTDOUBLE_FINISH = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 40,
		name: "showTv_giftDouble_finish"
	}//礼物翻倍视频完成次数/人数
	static SHOWTV_GIFTDOUBLE_SHOW = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 40.1,
		name: "showTv_giftDouble_show"
	}//礼物翻倍视频展示次数/人数
	static SHOWTV_GIFTDOUBLE_CLICK = {
		groupId: StatisticsManager.GROUP_ShowTv,
		sortId: 40.2,
		name: "showTv_giftDouble_click"
	}//礼物翻倍视频点击次数/人数
	...
	// -----------------------------------------------------分享相关----------------------------------------------------
	static SHARE_TURNTABLE_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 1,
		name: "share_LuckyRewardNub_finish"
	}//抽奖分享成功
	static SHARE_SETTLEMENT_CLICKSUCCESS = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 2,
		name: "share_BattleVictory_finish"
	}//结算翻倍点击分享按钮并成功分享的总用户数/次数
	static SHARE_POWERRECOVERY_CLICKSUCCESS = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 3,
		name: "share_PowerRecovery_finish"
	}//体力恢复展示分享按钮的总用户数/次数


	static SHARE_FREEGOLD_FINISH = {groupId: StatisticsManager.GROUP_Share, sortId: 4, name: "share_freeGold_finish"}//每日金币分享完成次数/人数
	static SHARE_OFFLINECOIN_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 5,
		name: "share_offlineCoin_finish"
	}//离线翻倍分享完成次数/人数
	static SHARE_UNLOCKROLE_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 6,
		name: "share_unlockRole_finish"
	}//解锁角色分享完成次数/人数
	static SHARE_BATTLEADDTION_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 7,
		name: "share_battleAddtion_finish"
	}//豪华开局分享完成次数/人数
	...
	static SHARE_UNLOCKROLEREWARD_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 10,
		name: "share_unlockRoleReward_finish"
	}//解锁角色奖励分享完成次数/人数
	...
	static SHARE_ROLEEVO_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 12,
		name: "share_roleEvolution_finish"
	}//角色进化分享完成次数
	static SHARE_VIDEOPIECE_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 13,
		name: "share_videoLottery_finish"
	}//视频抽装备分享完成次数
	static SHARE_ROLEEVOREWARD_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 14,
		name: "share_evolutionRoleReward_finish"
	}//角色进化奖励分享完成次数
	static SHARE_VIDEOPIECE_REWARD_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 15,
		name: "share_videoLotteryReward_finish"
	}//抽碎片双倍


	static SHARE_FOG_STARTROLE_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 16,
		name: "share_fog_startRole_finish"
	}//迷雾街区获得额外初始角色-分享完成次数/人数
	static SHARE_FOG_MOBILITYRECOVERY_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 17,
		name: "share_fog_mobilityRecovery_finish"
	}//迷雾街区恢复行动力分享完成次数/人数
	static SHARE_FOG_SETTLEMENT_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 18,
		name: "share_fog_settlement_finish"
	}//迷雾街区结算翻倍分享完成次数/人数
	static SHARE_FOG_SHOPREFRESH_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 19,
		name: "share_fog_shopRefresh_finish"
	}//迷雾街区商店刷新分享完成次数/人数
	static SHARE_FOG_CHOOSE_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 20,
		name: "share_fog_choose_finish"
	}//迷雾街区2选1奖励分享完成次数/人数
	static SHARE_FOG_BROKENROAD_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 21,
		name: "share_fog_brokenRoad_finish"
	}//迷雾街区坏路事件分享完成次数/人数
	static SHARE_FOG_BATTLE_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 22,
		name: "share_fog_battle_finish"
	}//迷雾街区战斗胜利翻倍分享完成次数/人数
	static SHARE_FOG_REMOVEBLOCK_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 23,
		name: "share_fog_removeBlock_finish"
	}//迷雾街区移除障碍物事件分享完成次数/人数
	...
	static SHARE_FOG_JITANG_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 25,
		name: "share_fog_jitang_finish"
	}//迷雾街区心灵鸡汤分享完成次数/人数


	static SHARE_CHAPTERBOX_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 26,
		name: "share_chapterbox_finish"
	}//章节宝箱分享完成次数/人数
	static SHARE_TASKREWARD_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 27,
		name: "share_taskreward_finish"
	}//任务奖励分享完成次数/人数
	static SHARE_TASKBOX_FINISH = {groupId: StatisticsManager.GROUP_Share, sortId: 28, name: "share_taskbox_finish"}//活跃度宝箱分享完成次数/人数


	static SHARE_FOG_RANDROLE_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 29,
		name: "share_fog_randRole_finish"
	}//迷雾街区战斗中随机获得角色分享完成次数/人数
	static SHARE_FOG_REVIVE_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 30,
		name: "share_fog_resurrection_finish"
	}//迷雾街区战败复活分享完成次数/人数
	static SHARE_FOG_QUESTION_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 31,
		name: "share_fog_question_finish"
	}//迷雾街区答题事件分享完成次数/人数


	static SHARE_LEVELOVERTIME_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 32,
		name: "share_levelOvertime_finish"
	}//关卡超时复活分享完成次数/人数
	...
	static SHARE_LEVELSKILL_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 34,
		name: "share_levelSkill_finish"
	}//关卡技能释放分享完成次数/人数
	static SHARE_ROLETRY_FINISH = {groupId: StatisticsManager.GROUP_Share, sortId: 35, name: "share_roleTry_finish"}//关卡技能释放分享完成次数/人数
	static SHARE_SHOPFRESH_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 36,
		name: "share_shopRefresh_finish"
	}//商店刷新分享完成次数/人数
	static SHARE_SHOPVIDEOBUY_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 37,
		name: "share_shopVideoBuy_finish"
	}//商店视频购买完成次数/人数

	static SHARE_WORKFRESH_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 38,
		name: "share_workRefresh_finish"
	}//工作刷新分享完成次数/人数
	static SHARE_WORKQUICK_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 39,
		name: "share_workQuickComplete_finish"
	}//工作快速完成分享完成次数/人数
	static SHARE_COMPANYUP_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 40,
		name: "share_companyUpdate_finish"
	}//公司升级分享完成次数/人数
	static SHARE_GIFTDOUBLE_FINISH = {
		groupId: StatisticsManager.GROUP_Share,
		sortId: 41,
		name: "share_giftDouble_finish"
	}//礼物翻倍分享完成次数/人数
