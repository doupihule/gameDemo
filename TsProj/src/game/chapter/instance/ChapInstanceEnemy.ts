...
export default class ChapInstanceEnemy extends FogInstanceBasic {
    ...
    public freshInfo() {
        ...
        if (this.levelId == level + 1) {
            ...
            this.fogControler.doCurLevelCode = TimerManager.instance.add(this.fogControler.nowLevelAni, this.fogControler, 800, Number.MAX_VALUE, false, [{ x: this.pos.x, y: this.pos.y - this.height + 20 }])
