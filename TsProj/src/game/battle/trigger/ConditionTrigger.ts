...
import SkillActionTrigger from "./SkillActionTrigger";
...
export default class ConditionTrigger {
    ...
    public static compareValue(value1: number, value2: number, compareType: number) {
        ...
        if (compareType == 1) { return disValue > 0 }
        else if (compareType == 2) { return disValue < 0 }
        else if (compareType == 3) { return disValue == 0 }
        else if (compareType == 4) { return disValue >= 0 }
        else if (compareType == 5) { return disValue <= 0 }
    }
