...
export default class AndroidGamePlatform extends GamePlatform {
    ...
    showVideoAd(successCallBack: any = null, closeCallBack: any = null, thisObj: any = null, extraData = {}) {
        ...
        if(this.isCasingPackage()){
            if(closeCallBack){closeCallBack.call(thisObj,false)};
            return;
        }
        ...
        NativeBridge.instance.callNative(JSToNativeEvent.TTADSDK_SHOWVEDIO, { scene: WindowManager.getCurrentWindowName() || "main",type:vedioType  });
    ...
    public onTTSDKAdCallBack(params) {
        ...
        //如果是有ecpm的 那么做ecpm统计
            ...
            StatisticsManager.ins.onEvent(StatisticsCommonConst.NORMAL_VIDEO_AD_ECPM,{ecpm:params.ecpm,level:params.ecpmLevel});
