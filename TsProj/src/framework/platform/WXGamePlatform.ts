            ...
            if (this.getWX().navigateToMiniProgram) {
                this.getWX().navigateToMiniProgram({
                    ...
                    success: (res) => {
                        ...
                        StatisticsManager.ins.onEvent(StatisticsCommonConst.JUMP_TO_OTHER_GAME_SUCCESS, { gameName: gameName, from: data.extraData && data.extraData.from, toAppId: toAppId, position: position });
                    },
                    fail: (res) => {
