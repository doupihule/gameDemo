...
class GameConsts {
     ...
     */
    static get gameName() {
        if (GameConsts._gameName[UserInfo_1.default.platformId]) {
            return GameConsts._gameName[UserInfo_1.default.platformId];
        }
        else {
 ...
 * 游戏名称[分渠道]
 */
GameConsts._gameName = {
    _default: '奇葩公寓',
};
//定一个一个空函数
GameConsts.emptyFunc = () => { };
...
GameConsts.JUMP_FANTASY_APPKEY = "flat";
/** 奇幻梦想互推参数：url*/
