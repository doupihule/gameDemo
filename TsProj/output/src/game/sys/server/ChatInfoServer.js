...
class ChatInfoServer {
    ...
    static upDateChatInfo(data, callBack = null, thisObj = null, isAsyc = false) {
        ...
        var info = ChatInfoModel_1.default.instance.getChatInfoById(roleId, taskId);
        if (!info) {
            var allLength = Object.keys(ChatInfoModel_1.default.instance.getAllChatByRole(roleId) || {}).length;
        ...
        if (type == 1) {
            ...
            var allCount = TaskFunc_1.default.instance.getCfgDatasByKey("Task", taskId, "frontChat").length;
            taskInfo["frontNum"] = count >= allCount ? allCount : count;
        }
        else if (type == 2) {
            //后置对话
            var count = (info && info.followNum || 0) + 1;
            var allCount = TaskFunc_1.default.instance.getCfgDatasByKey("Task", taskId, "followChat").length;
...
exports.default = ChatInfoServer;
//# sourceMappingURL=ChatInfoServer.js.map