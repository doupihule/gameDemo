...
declare module Laya {
    ...
    class  MiniFileMgr  {
        static getFileInfo(str:string):any;
        static getFileNativePath(str:string):any;
        static downOtherFiles(str:string,handle:Laya.Handler,path:string,isSave:boolean):any;
        static deleteFile(str:string,readurl:string,handle:Laya.Handler,encode:string, size:number):any;
        static filesListObj:any;
        static isLocalNativeFile:any;
