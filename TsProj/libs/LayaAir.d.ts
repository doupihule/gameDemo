...
declare module laya.filters {
	...
	class Filter implements laya.filters.IFilter  {
		 ...
		 */
		readonly type:number;
		static _filter:(sprite: Laya.Sprite, context: any, x: number, y: number) => void;
	}
...
declare module laya.net {
	...
	class URL  {
		...
		static _formatRelativePath(value:string);
	}
...
declare module Laya {
	 ...
	 * @date -2018-09-19
	 */
	class AdvImage extends Laya.Image  {
...
declare module Laya {
	 ...
	 */
	class Box extends Laya.UIComponent implements Laya.IBox  {
		private _bgColor:any;
...
{
    console.log("资源加载完成！");
    var button = new Laya.Button("resource/ui/button.png","label");//创建一个 Button 类的实例对象 button ,传入它的皮肤skin和标签label。
    button.x =100;//设置 button 对象的属性 x 的值，用于控制 button 对象的显示位置。
    button.y =100;//设置 button 对象的属性 y 的值，用于控制 button 对象的显示位置。
...
function onClickButton(button)
{
	 ...
	 * @example import Button=Laya.Button;
...
class Button_Example{
	 ...
	 */
	class Button extends Laya.UIComponent implements Laya.ISelect  {
...
function loadComplete() {
    console.log("资源加载完成！");
    var button:Laya.Button = new Laya.Button("button.png", "label");//创建一个 Button 类的实例对象 button ,传入它的皮肤skin和标签label。
    button.x = 100;//设置 button 对象的属性 x 的值，用于控制 button 对象的显示位置。
    button.y = 100;//设置 button 对象的属性 y 的值，用于控制 button 对象的显示位置。
    button.toggle = true;//设置 button 对象为切换按钮。
    button.clickHandler = laya.utils.Handler.create(this, onClickButton, [button], false);//设置 button 的点击事件处理器。
...
function onClickButton(button) {
    console.log("button.selected = ", button.selected);
		 ...
		 * @private 
		 */
		protected _bitmap:Laya.AutoBitmap;
...
{
    console.log("资源加载完成！");
    var checkBox:Laya.CheckBox= new Laya.CheckBox("resource/ui/check.png", "这个是一个CheckBox组件。");//创建一个 CheckBox 类的类的实例对象 checkBox ,传入它的皮肤skin和标签label。
    checkBox.x =100;//设置 checkBox 对象的属性 x 的值，用于控制 checkBox 对象的显示位置。
    checkBox.y =100;//设置 checkBox 对象的属性 y 的值，用于控制 checkBox 对象的显示位置。
...
function onClick(checkBox)
{
	 ...
	 * @example import CheckBox= Laya.CheckBox;
import Handler=laya.utils.Handler;
class CheckBox_Example{
	 ...
	 */
	class CheckBox extends Laya.Button  {
...
function loadComplete() {
    console.log("资源加载完成！");
    clip = new Laya.Clip("resource/ui/clip_num.png",10,1);//创建一个 Clip 类的实例对象 clip ,传入它的皮肤skin和横向分割数量、竖向分割数量。
    clip.autoPlay = true;//设置 clip 动画自动播放。
    clip.interval = 100;//设置 clip 动画的播放时间间隔。
    clip.x =100;//设置 clip 对象的属性 x 的值，用于控制 clip 对象的显示位置。
    clip.y =100;//设置 clip 对象的属性 y 的值，用于控制 clip 对象的显示位置。
...
class Clip_Example {
	 ...
	 */
	class Clip extends Laya.UIComponent  {
		 ...
		 */
		readonly bitmap:Laya.AutoBitmap;
...
{
    console.log("资源加载完成！");
    var colorPicket = new Laya.ColorPicker();//创建一个 ColorPicker 类的实例对象 colorPicket 。
    colorPicket.skin = "resource/ui/color.png";//设置 colorPicket 的皮肤。
    colorPicket.x = 100;//设置 colorPicket 对象的属性 x 的值，用于控制 colorPicket 对象的显示位置。
    colorPicket.y = 100;//设置 colorPicket 对象的属性 y 的值，用于控制 colorPicket 对象的显示位置。
...
function onChangeColor(colorPicket)
{
	 ...
	 * @example import ColorPicker = Laya.ColorPicker;
import Handler = laya.utils.Handler;
class ColorPicker_Example {
	 ...
	 */
	class ColorPicker extends Laya.UIComponent  {
		 ...
		 * @private 表示颜色样本列表面板。
		 */
		protected _colorPanel:Laya.Box;
		 ...
		 */
		protected _colorButton:Laya.Button;
...
function loadComplete() {
    console.log("资源加载完成！");
    var comboBox = new Laya.ComboBox("resource/ui/button.png", "item0,item1,item2,item3,item4,item5");//创建一个 ComboBox 类的实例对象 comboBox ,传入它的皮肤和标签集。
    comboBox.x = 100;//设置 comboBox 对象的属性 x 的值，用于控制 comboBox 对象的显示位置。
    comboBox.y = 100;//设置 comboBox 对象的属性 x 的值，用于控制 comboBox 对象的显示位置。
...
function onSelect(index)
{
	 ...
	 * @example import ComboBox = Laya.ComboBox;
import Handler = laya.utils.Handler;
class ComboBox_Example {
	 ...
	 */
	class ComboBox extends Laya.UIComponent  {
		 ...
		 */
		readonly scrollBar:Laya.VScrollBar;

		/**
		 * 获取对 <code>ComboBox</code> 组件所包含的 <code>Button</code> 组件的引用。
		 */
		readonly button:Laya.Button;
...
(function (_super) {//新建一个类Dialog_Instance继承自Laya.Dialog。
    function Dialog_Instance() {
        Dialog_Instance.__super.call(this);//初始化父类
        var bg = new Laya.Image("resource/ui/bg.png");//新建一个 Image 类的实例 bg 。
        bg.sizeGrid = "10,40,10,5";//设置 bg 的网格信息。
        bg.width = 150;//设置 bg 的宽度。
        bg.height = 250;//设置 bg 的高度。
        this.addChild(bg);//将 bg 添加到显示列表。
        var image = new Laya.Image("resource/ui/image.png");//新建一个 Image 类的实例 image 。
        this.addChild(image);//将 image 添加到显示列表。
        var button = new Laya.Button("resource/ui/btn_close.png");//新建一个 Button 类的实例 bg 。
        button.name = Laya.Dialog.CLOSE;//设置 button 的 name 属性值。
...
function onClose(name) {
    if (name == Laya.Dialog.CLOSE) {
        console.log("通过点击 name 为" + name + "的组件，关闭了dialog。");
    }
}
	 * @example import Dialog = Laya.Dialog;
import Handler = laya.utils.Handler;
...
class Dialog_Instance extends Dialog {
    Dialog_Instance(): void {
        var bg: Laya.Image = new Laya.Image("resource/ui/bg.png");
        bg.sizeGrid = "40,10,5,10";
        bg.width = 150;
        bg.height = 250;
        this.addChild(bg);
        var image: Laya.Image = new Laya.Image("resource/ui/image.png");
        this.addChild(image);
        var button: Button = new Button("resource/ui/btn_close.png");
        button.name = Dialog.CLOSE;//设置button的name属性值。
        button.x = 0;
	 ...
	 */
	class Dialog extends Laya.View  {
		 ...
		 */
		static manager:Laya.DialogManager;
		 ...
		 * @param view 锁定界面内容
		 */
		static setLockView(view:Laya.UIComponent):void;
...
declare module Laya {
	...
	class DialogManager extends laya.display.Sprite  {
		 ...
		 * 设置锁定界面，如果为空则什么都不显示
		 */
		setLockView(value:Laya.UIComponent):void;
		 ...
		 * @param showEffect 是否显示弹出效果
		 */
		open(dialog:Laya.Dialog,closeOther?:boolean,showEffect?:boolean):void;
		 ...
		 */
		doOpen(dialog:Laya.Dialog):void;
...
declare module Laya {
	 ...
	 */
	class FontClip extends Laya.Clip  {
...
declare module Laya {
	 ...
	 */
	class HBox extends Laya.LayoutBox  {
...
function onLoadComplete() {
    console.log("资源加载完成！");
    hScrollBar = new Laya.HScrollBar();//创建一个 HScrollBar 类的实例对象 hScrollBar 。
    hScrollBar.skin = "resource/ui/hscroll.png";//设置 hScrollBar 的皮肤。
    hScrollBar.x = 100;//设置 hScrollBar 对象的属性 x 的值，用于控制 hScrollBar 对象的显示位置。
    hScrollBar.y = 100;//设置 hScrollBar 对象的属性 y 的值，用于控制 hScrollBar 对象的显示位置。
...
function onChange(value)
{
	 ...
	 * @example import HScrollBar = Laya.HScrollBar;
import Handler = laya.utils.Handler;
class HScrollBar_Example {
	 ...
	 */
	class HScrollBar extends Laya.ScrollBar  {
...
function onLoadComplete() {
    console.log("资源加载完成！");
    hSlider = new Laya.HSlider();//创建一个 HSlider 类的实例对象 hSlider 。
    hSlider.skin = "resource/ui/hslider.png";//设置 hSlider 的皮肤。
    hSlider.min = 0;//设置 hSlider 最低位置值。
    hSlider.max = 10;//设置 hSlider 最高位置值。
    hSlider.value = 2;//设置 hSlider 当前位置值。
...
class HSlider_Example {
	 ...
	 * @see Laya.Slider
	 */
	class HSlider extends Laya.Slider  {
...
onInit();
function onInit() {
    var bg = new Laya.Image("resource/ui/bg.png");//创建一个 Image 类的实例对象 bg ,并传入它的皮肤。
    bg.x = 100;//设置 bg 对象的属性 x 的值，用于控制 bg 对象的显示位置。
    bg.y = 100;//设置 bg 对象的属性 y 的值，用于控制 bg 对象的显示位置。
    bg.sizeGrid = "40,10,5,10";//设置 bg 对象的网格信息。
    bg.width = 150;//设置 bg 对象的宽度。
    bg.height = 250;//设置 bg 对象的高度。
    Laya.stage.addChild(bg);//将此 bg 对象添加到显示列表。
    var image = new Laya.Image("resource/ui/image.png");//创建一个 Image 类的实例对象 image ,并传入它的皮肤。
    image.x = 100;//设置 image 对象的属性 x 的值，用于控制 image 对象的显示位置。
    image.y = 100;//设置 image 对象的属性 y 的值，用于控制 image 对象的显示位置。
    Laya.stage.addChild(image);//将此 image 对象添加到显示列表。
}
    ...
    private onInit(): void {
        var bg: Laya.Image = new Laya.Image("resource/ui/bg.png");//创建一个 Image 类的实例对象 bg ,并传入它的皮肤。
        bg.x = 100;//设置 bg 对象的属性 x 的值，用于控制 bg 对象的显示位置。
        bg.y = 100;//设置 bg 对象的属性 y 的值，用于控制 bg 对象的显示位置。
        bg.sizeGrid = "40,10,5,10";//设置 bg 对象的网格信息。
        bg.width = 150;//设置 bg 对象的宽度。
        bg.height = 250;//设置 bg 对象的高度。
        Laya.stage.addChild(bg);//将此 bg 对象添加到显示列表。
        var image: Laya.Image = new Laya.Image("resource/ui/image.png");//创建一个 Image 类的实例对象 image ,并传入它的皮肤。
        image.x = 100;//设置 image 对象的属性 x 的值，用于控制 image 对象的显示位置。
        image.y = 100;//设置 image 对象的属性 y 的值，用于控制 image 对象的显示位置。
        Laya.stage.addChild(image);//将此 image 对象添加到显示列表。
    }
	 ...
	 * @see Laya.AutoBitmap
	 */
	class Image extends Laya.UIComponent  {
...
function onInit(){
    ...
    label.height = 200;//设置 label 的高度。
    Laya.stage.addChild(label);//将 label 添加到显示列表。
    var passwordLabel = new Laya.Label("请原谅我，我不想被人看到我心里话。");//创建一个 Label 类的实例对象 passwordLabel 。
    passwordLabel.asPassword = true;//设置 passwordLabel 的显示反式为密码显示。
    passwordLabel.x = 100;//设置 passwordLabel 对象的属性 x 的值，用于控制 passwordLabel 对象的显示位置。
    passwordLabel.y = 350;//设置 passwordLabel 对象的属性 y 的值，用于控制 passwordLabel 对象的显示位置。
    passwordLabel.width = 300;//设置 passwordLabel 的宽度。
	 ...
	 * @example import Label = Laya.Label;
class Label_Example {
    constructor() {
        Laya.init(640, 800);//设置游戏画布宽高。
        Laya.stage.bgColor = "#efefef";//设置画布的背景颜色。
	 ...
	 */
	class Label extends Laya.UIComponent  {
...
declare module Laya {
	 ...
	 */
	class LayoutBox extends Laya.Box  {
...
Laya.loader.load(res, new laya.utils.Handler(this, onLoadComplete));//加载资源。
 function onLoadComplete() {
    ...
    for (var i = 0; i &lt; 20; i++) {
     ...
     var list = new Laya.List();//创建一个 List 类的实例对象 list 。
...
class Item extends Box {
	 ...
	 */
	class List extends Laya.Box implements Laya.IRender,Laya.IItem  {
		 ...
		 * @private 
		 */
		protected _content:Laya.Box;

		/**
		 * @private 
		 */
		protected _scrollBar:Laya.ScrollBar;
...
在此销毁、创建单元格，并设置单元格的位置等属性。相当于此列表内容发送改变时调用此函数。
		 ...
		 */
		protected addCell(cell:Laya.Box):void;
		 ...
		 */
		protected changeCellState(cell:Laya.Box,visible:boolean,index:number):void;
		 ...
		 * @param index 单元格索引。
		 */
		protected renderItem(cell:Laya.Box,index:number):void;
...
declare module Laya {
	...
	class Panel extends Laya.Box  {
		 ...
		 * @private 
		 */
		protected _vScrollBar:Laya.VScrollBar;

		/**
		 * @private 
		 */
		protected _hScrollBar:Laya.HScrollBar;
		 ...
		 * 垂直方向滚动条对象。
		 */
		readonly vScrollBar:Laya.ScrollBar;

		/**
		 * 水平方向滚动条对象。
		 */
		readonly hScrollBar:Laya.ScrollBar;
...
function onLoadComplete()
{
    progressBar = new Laya.ProgressBar("resource/ui/progress.png");//创建一个 ProgressBar 类的实例对象 progressBar 。
    progressBar.x = 100;//设置 progressBar 对象的属性 x 的值，用于控制 progressBar 对象的显示位置。
    progressBar.y = 100;//设置 progressBar 对象的属性 y 的值，用于控制 progressBar 对象的显示位置。
    progressBar.value = 0.3;//设置 progressBar 的进度值。
    progressBar.width = 200;//设置 progressBar 的宽度。
...
function onChange(value)
{
	 ...
	 * @example import ProgressBar = Laya.ProgressBar;
import Handler = laya.utils.Handler;
class ProgressBar_Example {
	 ...
	 */
	class ProgressBar extends Laya.UIComponent  {
		 ...
		 * 获取进度条对象。
		 */
		readonly bar:Laya.Image;

		/**
		 * 获取背景条对象。
		 */
		readonly bg:Laya.Image;
...
declare module Laya {
	 ...
	 * @see Laya.RadioGroup
	 */
	class Radio extends Laya.Button  {
...
function onLoadComplete() {
    var radioGroup= new Laya.RadioGroup();//创建一个 RadioGroup 类的实例对象 radioGroup 。
    radioGroup.pos(100, 100);//设置 radioGroup 的位置信息。
    radioGroup.labels = "item0,item1,item2";//设置 radioGroup 的标签集。
    radioGroup.skin = "resource/ui/radio.png";//设置 radioGroup 的皮肤。
    radioGroup.space = 10;//设置 radioGroup 的项间隔距离。
...
function onSelect(index) {
	 ...
	 * @example import Radio = Laya.Radio;
...
class RadioGroup_Example {
	 ...
	 */
	class RadioGroup extends Laya.UIGroup  {
...
declare module Laya {
	 ...
	 */
	class ScaleBox extends Laya.Box  {
		private _oldW:any;
		private _oldH:any;
...
declare module Laya {
	 ...
	 * @see Laya.HScrollBar
	 */
	class ScrollBar extends Laya.UIComponent  {
		 ...
		 * 上按钮
		 */
		upButton:Laya.Button;

		/**
		 * 下按钮
		 */
		downButton:Laya.Button;
...
declare module Laya {
	 ...
	 * @see Laya.VSlider
	 */
	class Slider extends Laya.UIComponent  {

		/**
		 * @private 获取对 <code>Slider</code> 组件所包含的 <code>Label</code> 组件的引用。
		 */
		static label:Laya.Label;
		 ...
		 * @private 
		 */
		protected _progress:Laya.Image;

		/**
		 * @private 
		 */
		protected _bar:Laya.Button;
...
function onLoadComplete() {
    var tab = new Laya.Tab();//创建一个 Tab 类的实例对象 tab 。
    tab.skin = "resource/ui/tab.png";//设置 tab 的皮肤。
    tab.labels = "item0,item1,item2";//设置 tab 的标签集。
    tab.x = 100;//设置 tab 对象的属性 x 的值，用于控制 tab 对象的显示位置。
    tab.y = 100;//设置 tab 对象的属性 y 的值，用于控制 tab 对象的显示位置。
...
class Tab_Example {
	 ...
	 */
	class Tab extends Laya.UIGroup  {
...
function onLoadComplete() {
    var textArea = new Laya.TextArea("这个一个TextArea实例。");//创建一个 TextArea 类的实例对象 textArea 。
    textArea.skin = "resource/ui/input.png";//设置 textArea 的皮肤。
    textArea.sizeGrid = "4,4,4,4";//设置 textArea 的网格信息。
    textArea.color = "#008fff";//设置 textArea 的文本颜色。
    textArea.font = "Arial";//设置 textArea 的字体。
	 ...
	 * @example import TextArea = Laya.TextArea;
import Handler = laya.utils.Handler;
class TextArea_Example {
	 ...
	 */
	class TextArea extends Laya.TextInput  {
		 ...
		 * 垂直滚动条实体
		 */
		readonly vScrollBar:Laya.VScrollBar;

		/**
		 * 水平滚动条实体
		 */
		readonly hScrollBar:Laya.HScrollBar;
...
Laya.loader.load(["resource/ui/input.png"], laya.utils.Handler.create(this, onLoadComplete));//加载资源。
function onLoadComplete() {
    var textInput = new Laya.TextInput("这是一个TextInput实例。");//创建一个 TextInput 类的实例对象 textInput 。
    textInput.skin = "resource/ui/input.png";//设置 textInput 的皮肤。
    textInput.sizeGrid = "4,4,4,4";//设置 textInput 的网格信息。
    textInput.color = "#008fff";//设置 textInput 的文本颜色。
    textInput.font = "Arial";//设置 textInput 的文本字体。
...
class TextInput_Example {
	 ...
	 */
	class TextInput extends Laya.Label  {

		/**
		 * @private 
		 */
		protected _bg:Laya.AutoBitmap;
...
declare module Laya {
	 ...
	 * 鼠标提示管理类
	 */
	class TipManager extends Laya.UIComponent  {
...
function onLoadComplete() {
    ...
    var xml = domParser.parseFromString(xmlString, "text/xml");//解析xml字符。
     var tree = new Laya.Tree();//创建一个 Tree 类的实例对象 tree 。
    tree.scrollBarSkin = "resource/ui/vscroll.png";//设置 tree 的皮肤。
...
(function (_super) {
    function Item() {
        ...
        this.right = 0;
        this.left = 0;
         var selectBox = new Laya.Clip("resource/ui/clip_selectBox.png", 1, 2);
        ...
        this.addChild(selectBox);//需要使用this.访问父类的属性或方法。
         var folder = new Laya.Clip("resource/ui/clip_tree_folder.png", 1, 3);
        ...
        label.right = 0;
        this.addChild(label);
         var arrow = new Laya.Clip("resource/ui/clip_tree_arrow.png", 1, 2);
...
class Item extends Box {
	 ...
	 */
	class Tree extends Laya.Box implements Laya.IRender  {
		 ...
		 * 滚动条
		 */
		readonly scrollBar:Laya.ScrollBar;
...
declare module Laya {
	 ...
	 */
	class UIGroup extends Laya.Box implements Laya.IItem  {
		 ...
		 * @return 
		 */
		addItem(item:Laya.ISelect,autoLayOut?:boolean):number;
		 ...
		 * @param autoLayOut 是否自动布局，如果为true，会根据 <code>direction</code> 和 <code>space</code> 属性计算item的位置。
		 */
		delItem(item:Laya.ISelect,autoLayOut?:boolean):void;
		 ...
		 * 项对象们的存放数组。
		 */
		readonly items:Laya.ISelect[];

		/**
		 * 获取或设置当前选择的项对象。
		 */
		selection:Laya.ISelect;
...
declare module Laya {
	 ...
	 */
	class VBox extends Laya.LayoutBox  {
...
注册UI配置信息，比如注册一个路径为"test/TestPage"的页面，UI内容是IDE生成的json
		...
		/**
		 * @implements Laya.UIComponent#dataSource
		 */
		dataSource:any;
	}
...
declare module Laya {
	 ...
	 */
	class ViewStack extends Laya.Box implements Laya.IItem  {
...
Laya.loader.load(res, laya.utils.Handler.create(this, onLoadComplete));//加载资源。
function onLoadComplete() {
    vScrollBar = new Laya.VScrollBar();//创建一个 vScrollBar 类的实例对象 hScrollBar 。
    vScrollBar.skin = "resource/ui/vscroll.png";//设置 vScrollBar 的皮肤。
    vScrollBar.x = 100;//设置 vScrollBar 对象的属性 x 的值，用于控制 vScrollBar 对象的显示位置。
    vScrollBar.y = 100;//设置 vScrollBar 对象的属性 y 的值，用于控制 vScrollBar 对象的显示位置。
...
function onChange(value) {
	 ...
	 * @example import VScrollBar = Laya.VScrollBar;
import Handler = laya.utils.Handler;
class VScrollBar_Example {
	 ...
	 */
	class VScrollBar extends Laya.ScrollBar  {
	}
...
function onLoadComplete() {
    vSlider = new Laya.VSlider();//创建一个 VSlider 类的实例对象 vSlider 。
    vSlider.skin = "resource/ui/vslider.png";//设置 vSlider 的皮肤。
    vSlider.min = 0;//设置 vSlider 最低位置值。
    vSlider.max = 10;//设置 vSlider 最高位置值。
    vSlider.value = 2;//设置 vSlider 当前位置值。
...
function onChange(value) {
	 ...
	 * @example import HSlider = Laya.HSlider;
...
class VSlider_Example {
	 ...
	 * @see Laya.Slider
	 */
	class VSlider extends Laya.Slider  {
	}
...
declare module Laya {
	 ...
	 */
	class WXOpenDataViewer extends Laya.UIComponent  {
...
declare module laya.webgl.text {
	class TextRender  {
		...
		_fast_filltext(ctx:laya.resource.Context,data:string|laya.utils.WordText|null,htmlchars:any,x:number,y:number,font:laya.utils.FontInfo,color:string,strokeColor:string,lineWidth:number,textAlign:number,underLine?:number):void;
...
declare module laya.webgl {
	 ...
	 */
	declare class Laya  {
		static MiniFileMgr:any;
		static MiniAdpter:any;
		/**
		 * 舞台对象的引用。
		 */
...
<p>请使用 <code>HTMLImage.create()<code>获取新实例，不要直接使用 <code>new HTMLImage<code> 。</p>
	...
	class AdvImage extends Laya.AdvImage {}
	...
	class AutoBitmap extends Laya.AutoBitmap {}
...
class CheckBox_Example{
	...
	class CheckBox extends Laya.CheckBox {}
...
class ColorPicker_Example {
	...
	class ColorPicker extends Laya.ColorPicker {}
...
class ComboBox_Example {
	...
	class ComboBox extends Laya.ComboBox {}
...
class Dialog_Instance extends Dialog {
	...
	class DialogManager extends Laya.DialogManager {}
	...
	class FontClip extends Laya.FontClip {}

	/**
	 * <code>HBox</code> 是一个水平布局容器类。
	 */

	class HBox extends Laya.HBox {}
...
class HScrollBar_Example {
	...
	class HScrollBar extends Laya.HScrollBar {}
...
class HSlider_Example {
	...
	class HSlider extends Laya.HSlider {}
...
class Label_Example {
	...
	class Label extends Laya.Label {}

	/**
	 * <code>LayoutBox</code> 是一个布局容器类。
	 */

	class LayoutBox extends Laya.LayoutBox {}
...
class Item extends Box {
	...
	class List extends Laya.List {}

	/**
	 * <code>Panel</code> 是一个面板容器类。
	 */

	class Panel extends Laya.Panel {}
...
class ProgressBar_Example {
	...
	class ProgressBar extends Laya.ProgressBar {}
	...
	class Radio extends Laya.Radio {}
...
class RadioGroup_Example {
	...
	class RadioGroup extends Laya.RadioGroup {}

	/**
	 * 自适应缩放容器，容器设置大小后，容器大小始终保持stage大小，子内容按照原始最小宽高比缩放
	 */

	class ScaleBox extends Laya.ScaleBox {}
	...
	class ScrollBar extends Laya.ScrollBar {}
	...
	class Slider extends Laya.Slider {}

	/**
	 * <code>Styles</code> 定义了组件常用的样式属性。
	 */

	class Styles extends Laya.Styles {}
...
class TextArea_Example {
	...
	class TextArea extends Laya.TextArea {}
...
class TextInput_Example {
	...
	class TextInput extends Laya.TextInput {}

	/**
	 * 鼠标提示管理类
	 */

	class TipManager extends Laya.TipManager {}
...
class Item extends Box {
	...
	class UIComponent extends Laya.UIComponent {}

	/**
	 * <code>UIEvent</code> 类用来定义UI组件类的事件类型。
	 */

	class UIEvent extends Laya.UIEvent {}
	...
	class UIGroup extends Laya.UIGroup {}

	class UILib extends Laya.UILib {}

	/**
	 * <code>UIUtils</code> 是文本工具集。
	 */

	class UIUtils extends Laya.UIUtils {}

	/**
	 * <code>VBox</code> 是一个垂直布局容器类。
	 */

	class VBox extends Laya.VBox {}
	...
	class ViewStack extends Laya.ViewStack {}
...
class VScrollBar_Example {
	...
	class VScrollBar extends Laya.VScrollBar {}
...
class VSlider_Example {
	...
	class VSlider extends Laya.VSlider {}

	/**
	 * 相对布局插件
	 */

	class Widget extends Laya.Widget {}

	/**
	 * 微信开放数据展示组件，直接实例本组件，即可根据组件宽高，位置，以最优的方式显示开放域数据
	 */

	class WXOpenDataViewer extends Laya.WXOpenDataViewer {}
