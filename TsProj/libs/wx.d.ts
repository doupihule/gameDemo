...
declare namespace wx {
  ...
  /**
       * 退出当前小游戏
       */
  export function exitMiniProgram(object: { success: (res: any) => void, fail: (res: any) => void, complete: (res: any) => void }): void;
  /**
   ...
   * 获取网络类型。
   */
  export function getNetworkType(object: any): void;
   ...
   */
  export function setStorageSync(key: string,value): void;
   ...
   * 使手机发生较长时间的振动（400ms）
   */
  export function vibrateLong(object: any): void;

  /**
   * 使手机发生较短时间的振动（15ms）
   */
  export function vibrateShort(object: any): void;
  ...
  export function mtShowJumpMiniProgramEvent(object:any):void;
  export function mtJumpMiniProgramEvent(object:any):void;
  export function mtDrawerSpreadEvent(object:any):void;
  export function createGameClubButton(p:any):void;
  export function onError(p:any):void;
  export function onMemoryWarning(p:any):void;
  export function onShow(p:any):void;
  export function onHide(p:any):void;
  export function getLaunchOptionsSync():any;
  export function getMenuButtonBoundingClientRect():any;
  export function createUserInfoButton(p:any):any;
  export function createRewardedVideoAd(p:any):any;
  export function aldShareAppMessage(p:any):void;
  export function aldOnShareAppMessage(p:any):void;
  export function aldSendEvent(p1,p2:any):void;
  export function openCustomerServiceConversation(p1:any):void;
