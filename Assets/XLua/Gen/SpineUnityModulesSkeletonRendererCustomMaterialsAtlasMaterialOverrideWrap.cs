...
namespace XLua.CSObjectWrap
{
    ...
    public class SpineUnityModulesSkeletonRendererCustomMaterialsAtlasMaterialOverrideWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Spine.Unity.Modules.SkeletonRendererCustomMaterials.AtlasMaterialOverride);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(Spine.Unity.Modules.SkeletonRendererCustomMaterials.AtlasMaterialOverride));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Spine.Unity.Modules.SkeletonRendererCustomMaterials.AtlasMaterialOverride constructor!");
        ...
        static int _m_Equals(RealStatePtr L)
        {
		    try {
                ...
                Spine.Unity.Modules.SkeletonRendererCustomMaterials.AtlasMaterialOverride gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
            
            
                
                {
                    Spine.Unity.Modules.SkeletonRendererCustomMaterials.AtlasMaterialOverride _other;translator.Get(L, 2, out _other);
