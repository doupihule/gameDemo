...
namespace XLua.CSObjectWrap
{
    ...
    public class SpinePathConstraintPositionTimelineWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Spine.PathConstraintPositionTimeline);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "PathConstraintIndex", _g_get_PathConstraintIndex);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "Frames", _g_get_Frames);
            
			Utils.RegisterFunc(L, Utils.SETTER_IDX, "PathConstraintIndex", _s_set_PathConstraintIndex);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "ENTRIES", Spine.PathConstraintPositionTimeline.ENTRIES);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					Spine.PathConstraintPositionTimeline gen_ret = new Spine.PathConstraintPositionTimeline(_frameCount);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Spine.PathConstraintPositionTimeline constructor!");
        ...
        static int _m_SetFrame(RealStatePtr L)
        {
		    try {
                ...
                Spine.PathConstraintPositionTimeline gen_to_be_invoked = (Spine.PathConstraintPositionTimeline)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetFrame( _frameIndex, _time, _value );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_PathConstraintIndex(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Spine.PathConstraintPositionTimeline gen_to_be_invoked = (Spine.PathConstraintPositionTimeline)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.PathConstraintIndex);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_PathConstraintIndex(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Spine.PathConstraintPositionTimeline gen_to_be_invoked = (Spine.PathConstraintPositionTimeline)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.PathConstraintIndex = LuaAPI.xlua_tointeger(L, 2);
