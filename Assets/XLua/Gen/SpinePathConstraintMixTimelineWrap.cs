...
namespace XLua.CSObjectWrap
{
    ...
    public class SpinePathConstraintMixTimelineWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Spine.PathConstraintMixTimeline);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "ENTRIES", Spine.PathConstraintMixTimeline.ENTRIES);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					Spine.PathConstraintMixTimeline gen_ret = new Spine.PathConstraintMixTimeline(_frameCount);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Spine.PathConstraintMixTimeline constructor!");
        ...
        static int _m_SetFrame(RealStatePtr L)
        {
		    try {
                ...
                Spine.PathConstraintMixTimeline gen_to_be_invoked = (Spine.PathConstraintMixTimeline)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetFrame( _frameIndex, _time, _rotateMix, _translateMix );
