...
namespace XLua.CSObjectWrap
{
    ...
    public class SpineUnityModulesSkeletonRagdoll2DWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Spine.Unity.Modules.SkeletonRagdoll2D);
			Utils.BeginObjectRegister(type, L, translator, 0, 5, 19, 13);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Spine.Unity.Modules.SkeletonRagdoll2D gen_ret = new Spine.Unity.Modules.SkeletonRagdoll2D();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Spine.Unity.Modules.SkeletonRagdoll2D constructor!");
        ...
        static int _m_Apply(RealStatePtr L)
        {
		    try {
                ...
                Spine.Unity.Modules.SkeletonRagdoll2D gen_to_be_invoked = (Spine.Unity.Modules.SkeletonRagdoll2D)translator.FastGetCSObj(L, 1);
		    ...
		    try {
                ...
                
                {
                    string _boneName = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.Rigidbody2D gen_ret = gen_to_be_invoked.GetRigidbody( _boneName );
                        translator.Push(L, gen_ret);
