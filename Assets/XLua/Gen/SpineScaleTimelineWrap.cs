...
namespace XLua.CSObjectWrap
{
    ...
    public class SpineScaleTimelineWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Spine.ScaleTimeline);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					Spine.ScaleTimeline gen_ret = new Spine.ScaleTimeline(_frameCount);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Spine.ScaleTimeline constructor!");
        ...
        static int _m_Apply(RealStatePtr L)
        {
		    try {
                ...
                Spine.ScaleTimeline gen_to_be_invoked = (Spine.ScaleTimeline)translator.FastGetCSObj(L, 1);
