...
namespace XLua.CSObjectWrap
{
    ...
    public class SpineEventWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Spine.Event);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<Spine.EventData>(L, 3))
				{
					float _time = (float)LuaAPI.lua_tonumber(L, 2);
					Spine.EventData _data = (Spine.EventData)translator.GetObject(L, 3, typeof(Spine.EventData));
					
					Spine.Event gen_ret = new Spine.Event(_time, _data);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Spine.Event constructor!");
        ...
        static int _m_ToString(RealStatePtr L)
        {
		    try {
                ...
                Spine.Event gen_to_be_invoked = (Spine.Event)translator.FastGetCSObj(L, 1);
