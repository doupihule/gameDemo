...
namespace XLua.CSObjectWrap
{
    ...
    public class GameUtilsCRC32Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(GameUtils.CRC32);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					GameUtils.CRC32 gen_ret = new GameUtils.CRC32();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to GameUtils.CRC32 constructor!");
		    ...
		    try {
                ...
                
                {
                    ...
                    int _len = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        ulong gen_ret = GameUtils.CRC32.GetCRC32( _buffer, _len );
