...
namespace XLua.CSObjectWrap
{
    ...
    public class SpineColorTimelineWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Spine.ColorTimeline);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "ENTRIES", Spine.ColorTimeline.ENTRIES);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					Spine.ColorTimeline gen_ret = new Spine.ColorTimeline(_frameCount);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Spine.ColorTimeline constructor!");
        ...
        static int _m_SetFrame(RealStatePtr L)
        {
		    try {
                ...
                Spine.ColorTimeline gen_to_be_invoked = (Spine.ColorTimeline)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetFrame( _frameIndex, _time, _r, _g, _b, _a );
