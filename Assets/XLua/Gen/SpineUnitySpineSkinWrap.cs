...
namespace XLua.CSObjectWrap
{
    ...
    public class SpineUnitySpineSkinWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Spine.Unity.SpineSkin);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 5 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) && (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING) && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4) && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 5))
				{
					...
					Spine.Unity.SpineSkin gen_ret = new Spine.Unity.SpineSkin(_startsWith, _dataField, _includeNone, _fallbackToTextField);
				...
				if(LuaAPI.lua_gettop(L) == 4 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) && (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING) && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4))
				{
					...
					Spine.Unity.SpineSkin gen_ret = new Spine.Unity.SpineSkin(_startsWith, _dataField, _includeNone);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 3 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) && (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING))
				{
					...
					Spine.Unity.SpineSkin gen_ret = new Spine.Unity.SpineSkin(_startsWith, _dataField);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 2 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING))
				{
					...
					Spine.Unity.SpineSkin gen_ret = new Spine.Unity.SpineSkin(_startsWith);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Spine.Unity.SpineSkin gen_ret = new Spine.Unity.SpineSkin();
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Spine.Unity.SpineSkin constructor!");
