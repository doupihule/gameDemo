...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineComponentWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetComponentsInChildrenExtension", _m_GetComponentsInChildrenExtension);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetComponentFromName", _m_GetComponentFromName);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetComponentsInChildrenExtension(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _includeInactive = LuaAPI.lua_toboolean(L, 3);
                        ...
                        UnityEngine.Component[] gen_ret = gen_to_be_invoked.GetComponentsInChildrenExtension( _t, _includeInactive );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _t = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.Component[] gen_ret = gen_to_be_invoked.GetComponentsInChildrenExtension( _t );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Component.GetComponentsInChildrenExtension!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetComponentFromName(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    string _componentName = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.Component gen_ret = gen_to_be_invoked.GetComponentFromName( _componentName );
                        translator.Push(L, gen_ret);
