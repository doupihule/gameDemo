...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIImageWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 9, 22, 12);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetDisabled", _m_SetDisabled);
        ...
        static int _m_SetColor(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Color _c;translator.Get(L, 2, out _c);
                    
                    gen_to_be_invoked.SetColor( _c );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetDisabled(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetDisabled( _isActive );
