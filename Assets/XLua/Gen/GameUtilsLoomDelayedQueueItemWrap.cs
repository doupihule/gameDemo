...
namespace XLua.CSObjectWrap
{
    ...
    public class GameUtilsLoomDelayedQueueItemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(GameUtils.Loom.DelayedQueueItem);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(GameUtils.Loom.DelayedQueueItem));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to GameUtils.Loom.DelayedQueueItem constructor!");
        ...
        static int _g_get_time(RealStatePtr L)
        {
		    try {
                ...
                GameUtils.Loom.DelayedQueueItem gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
