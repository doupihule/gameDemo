...
namespace XLua.CSObjectWrap
{
    ...
    public class SpineSkeletonFlipClipWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(SpineSkeletonFlipClip);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					SpineSkeletonFlipClip gen_ret = new SpineSkeletonFlipClip();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to SpineSkeletonFlipClip constructor!");
        ...
        static int _m_CreatePlayable(RealStatePtr L)
        {
		    try {
                ...
                SpineSkeletonFlipClip gen_to_be_invoked = (SpineSkeletonFlipClip)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_template(RealStatePtr L)
        {
		    try {
                ...
                SpineSkeletonFlipClip gen_to_be_invoked = (SpineSkeletonFlipClip)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.template = (SpineSkeletonFlipBehaviour)translator.GetObject(L, 2, typeof(SpineSkeletonFlipBehaviour));
