...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineCameraWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 40, 56, 43);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "CameraToRaycastHitObjectClick", _m_CameraToRaycastHitObjectClick);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetCameraPositionToUICameraPosition", _m_GetCameraPositionToUICameraPosition);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_CameraToRaycastHitObjectClick(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    System.Action _onClickHandle = translator.GetDelegate<System.Action>(L, 3);
                    
                        bool gen_ret = gen_to_be_invoked.CameraToRaycastHitObjectClick( _go, _onClickHandle );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetCameraPositionToUICameraPosition(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3 _pos;translator.Get(L, 3, out _pos);
                        ...
                        UnityEngine.Vector3 gen_ret = gen_to_be_invoked.GetCameraPositionToUICameraPosition( _mainCamera, _pos );
                        translator.PushUnityEngineVector3(L, gen_ret);
