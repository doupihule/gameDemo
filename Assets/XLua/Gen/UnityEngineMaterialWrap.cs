...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineMaterialWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 41, 11, 10);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ToSpineAtlasPage", _m_ToSpineAtlasPage);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ToSpineAtlasPage(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        Spine.AtlasPage gen_ret = gen_to_be_invoked.ToSpineAtlasPage(  );
                        translator.Push(L, gen_ret);
