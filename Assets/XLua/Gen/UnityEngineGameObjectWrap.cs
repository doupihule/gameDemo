...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineGameObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetComponentInChild", _m_GetComponentInChild);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "InstantiateGameObject", _m_InstantiateGameObject);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Destroy", _m_Destroy);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetChildrenLayer", _m_SetChildrenLayer);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "PlaySounds", _m_PlaySounds);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ClearSounds", _m_ClearSounds);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetComponentInChild(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    string _componentName = LuaAPI.lua_tostring(L, 3);
                        ...
                        UnityEngine.Component gen_ret = gen_to_be_invoked.GetComponentInChild( _childName, _componentName );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_InstantiateGameObject(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.GameObject>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _shouldRegister = LuaAPI.lua_toboolean(L, 3);
                    
                        UnityEngine.GameObject gen_ret = gen_to_be_invoked.InstantiateGameObject( _parentObj, _shouldRegister );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.GameObject>(L, 2)) 
                {
                    UnityEngine.GameObject _parentObj = (UnityEngine.GameObject)translator.GetObject(L, 2, typeof(UnityEngine.GameObject));
                        ...
                        UnityEngine.GameObject gen_ret = gen_to_be_invoked.InstantiateGameObject( _parentObj );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.GameObject.InstantiateGameObject!");
        ...
        static int _m_Destroy(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.GameObject.Destroy!");
        ...
        static int _m_SetChildrenLayer(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetChildrenLayer( _Layer );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_PlaySounds(RealStatePtr L)
        {
		    try {
                ...
                {
                    bool _isPreloading = LuaAPI.lua_toboolean(L, 2);
                    ...
                    gen_to_be_invoked.PlaySounds( _isPreloading, _assetName, _path, _bundleName, _delay );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ClearSounds(RealStatePtr L)
        {
		    try {
