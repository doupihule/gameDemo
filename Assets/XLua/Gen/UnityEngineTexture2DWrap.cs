...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTexture2DWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 24, 9, 1);
        ...
        static int _m_ToAtlasRegion(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Material>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _scale = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        Spine.AtlasRegion gen_ret = gen_to_be_invoked.ToAtlasRegion( _materialPropertySource, _scale );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Material>(L, 2)) 
                {
                    UnityEngine.Material _materialPropertySource = (UnityEngine.Material)translator.GetObject(L, 2, typeof(UnityEngine.Material));
                        ...
                        Spine.AtlasRegion gen_ret = gen_to_be_invoked.ToAtlasRegion( _materialPropertySource );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Shader>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<UnityEngine.Material>(L, 4)) 
                {
                    UnityEngine.Shader _shader = (UnityEngine.Shader)translator.GetObject(L, 2, typeof(UnityEngine.Shader));
                    float _scale = (float)LuaAPI.lua_tonumber(L, 3);
                    UnityEngine.Material _materialPropertySource = (UnityEngine.Material)translator.GetObject(L, 4, typeof(UnityEngine.Material));
                    
                        Spine.AtlasRegion gen_ret = gen_to_be_invoked.ToAtlasRegion( _shader, _scale, _materialPropertySource );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Shader>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    UnityEngine.Shader _shader = (UnityEngine.Shader)translator.GetObject(L, 2, typeof(UnityEngine.Shader));
                    float _scale = (float)LuaAPI.lua_tonumber(L, 3);
                    
                        Spine.AtlasRegion gen_ret = gen_to_be_invoked.ToAtlasRegion( _shader, _scale );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Shader>(L, 2)) 
                {
                    UnityEngine.Shader _shader = (UnityEngine.Shader)translator.GetObject(L, 2, typeof(UnityEngine.Shader));
                        ...
                        Spine.AtlasRegion gen_ret = gen_to_be_invoked.ToAtlasRegion( _shader );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Texture2D.ToAtlasRegion!");
        ...
        static int _m_ToAtlasRegionPMAClone(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Texture2D.ToAtlasRegionPMAClone!");
