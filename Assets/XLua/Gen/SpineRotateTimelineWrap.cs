...
namespace XLua.CSObjectWrap
{
    ...
    public class SpineRotateTimelineWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Spine.RotateTimeline);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "ENTRIES", Spine.RotateTimeline.ENTRIES);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					Spine.RotateTimeline gen_ret = new Spine.RotateTimeline(_frameCount);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Spine.RotateTimeline constructor!");
        ...
        static int _m_SetFrame(RealStatePtr L)
        {
		    try {
                ...
                Spine.RotateTimeline gen_to_be_invoked = (Spine.RotateTimeline)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    ...
                    float _degrees = (float)LuaAPI.lua_tonumber(L, 4);
                    
                    gen_to_be_invoked.SetFrame( _frameIndex, _time, _degrees );
