...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp8(UnityEngine.AsyncOperation p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp17(Spine.TrackEntry p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp18(Spine.TrackEntry p0, Spine.Event p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp19(Spine.Unity.ISkeletonAnimation p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp20(Spine.Unity.SkeletonRenderer p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp21(Spine.Unity.MeshGeneratorBuffers p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp22(Spine.Unity.SkeletonRendererInstruction p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp23(Spine.Event p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp24(float p0, float p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp26(long p0, long p1, long p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public Resource.FileVersionData __Gen_Delegate_Imp27(int p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                Resource.FileVersionData __gen_ret = (Resource.FileVersionData)translator.GetObject(L, errFunc + 1, typeof(Resource.FileVersionData));
                LuaAPI.lua_settop(L, errFunc - 1);
                return  __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
		...
		public void __Gen_Delegate_Imp28(Resource.FileVersionData p0, bool p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp29(UnityEngine.Object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new UnityEngine.Display.DisplaysUpdatedDelegate(__Gen_Delegate_Imp1);
			}
		    ...
		    if (type == typeof(Spine.Unity.SkeletonUtility.SkeletonUtilityDelegate))
			{
			...
			{
			    return new System.Action<UnityEngine.AsyncOperation>(__Gen_Delegate_Imp8);
			}
			...
			{
			    return new Spine.AnimationState.TrackEntryDelegate(__Gen_Delegate_Imp17);
			}
		
		    if (type == typeof(Spine.AnimationState.TrackEntryEventDelegate))
			{
			    return new Spine.AnimationState.TrackEntryEventDelegate(__Gen_Delegate_Imp18);
			}
		
		    if (type == typeof(Spine.Unity.UpdateBonesDelegate))
			{
			    return new Spine.Unity.UpdateBonesDelegate(__Gen_Delegate_Imp19);
			}
		
		    if (type == typeof(Spine.Unity.SkeletonRenderer.SkeletonRendererDelegate))
			{
			    return new Spine.Unity.SkeletonRenderer.SkeletonRendererDelegate(__Gen_Delegate_Imp20);
			}
		
		    if (type == typeof(Spine.Unity.MeshGeneratorDelegate))
			{
			    return new Spine.Unity.MeshGeneratorDelegate(__Gen_Delegate_Imp21);
			}
		
		    if (type == typeof(Spine.Unity.SkeletonRenderer.InstructionDelegate))
			{
			    return new Spine.Unity.SkeletonRenderer.InstructionDelegate(__Gen_Delegate_Imp22);
			}
		
		    if (type == typeof(Spine.Unity.Playables.SpineEventDelegate))
			{
			    return new Spine.Unity.Playables.SpineEventDelegate(__Gen_Delegate_Imp23);
			}
		
		    if (type == typeof(System.Action<float, float>))
			{
			    return new System.Action<float, float>(__Gen_Delegate_Imp24);
			}
		    ...
		    if (type == typeof(System.Action<long, long, long>))
			{
			    return new System.Action<long, long, long>(__Gen_Delegate_Imp26);
			}
		
		    if (type == typeof(System.Func<int, Resource.FileVersionData>))
			{
			    return new System.Func<int, Resource.FileVersionData>(__Gen_Delegate_Imp27);
			}
		
		    if (type == typeof(System.Action<Resource.FileVersionData, bool>))
			{
			    return new System.Action<Resource.FileVersionData, bool>(__Gen_Delegate_Imp28);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Object>))
			{
			    return new System.Action<UnityEngine.Object>(__Gen_Delegate_Imp29);
			}
		
		    if (type == typeof(System.Action<int, int>))
			{
			    return new System.Action<int, int>(__Gen_Delegate_Imp30);
			}
