...
namespace XLua.CSObjectWrap
{
    ...
    public class SpineShearTimelineWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Spine.ShearTimeline);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					Spine.ShearTimeline gen_ret = new Spine.ShearTimeline(_frameCount);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Spine.ShearTimeline constructor!");
        ...
        static int _m_Apply(RealStatePtr L)
        {
		    try {
                ...
                Spine.ShearTimeline gen_to_be_invoked = (Spine.ShearTimeline)translator.FastGetCSObj(L, 1);
