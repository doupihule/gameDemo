...
namespace XLua.CSObjectWrap
{
    ...
    public class SpineIkConstraintTimelineWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Spine.IkConstraintTimeline);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "IkConstraintIndex", _g_get_IkConstraintIndex);
			...
			Utils.RegisterFunc(L, Utils.SETTER_IDX, "IkConstraintIndex", _s_set_IkConstraintIndex);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "ENTRIES", Spine.IkConstraintTimeline.ENTRIES);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					Spine.IkConstraintTimeline gen_ret = new Spine.IkConstraintTimeline(_frameCount);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Spine.IkConstraintTimeline constructor!");
        ...
        static int _m_SetFrame(RealStatePtr L)
        {
		    try {
                ...
                Spine.IkConstraintTimeline gen_to_be_invoked = (Spine.IkConstraintTimeline)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    ...
                    float _mix = (float)LuaAPI.lua_tonumber(L, 4);
                    int _bendDirection = LuaAPI.xlua_tointeger(L, 5);
                    
                    gen_to_be_invoked.SetFrame( _frameIndex, _time, _mix, _bendDirection );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_IkConstraintIndex(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Spine.IkConstraintTimeline gen_to_be_invoked = (Spine.IkConstraintTimeline)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.IkConstraintIndex);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_IkConstraintIndex(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Spine.IkConstraintTimeline gen_to_be_invoked = (Spine.IkConstraintTimeline)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.IkConstraintIndex = LuaAPI.xlua_tointeger(L, 2);
