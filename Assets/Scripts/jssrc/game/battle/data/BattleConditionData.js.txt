...
class BattleConditionData {
    constructor(id) {
        this._id = id;
        this.cfgData = BattleFunc_1.default.instance.getCfgDatas("Condition", id);
...
exports.default = BattleConditionData;
//# sourceMappingURL=BattleConditionData.js.map