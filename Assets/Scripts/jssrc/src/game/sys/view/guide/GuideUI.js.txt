...
class GuideUI extends layaMaxUI_1.ui.gameui.guide.GuideUI {
    constructor() {
        super();
        this.timeCode = 0;
        /* 手指的方位，暂时无用 */
        ...
        new ButtonUtils_1.ButtonUtils(this.jump, this.skipGuide, this);
    ...
    skipGuide() {
        GuideManager_1.default.ins.guideFin(this.guideId, () => {
            WindowManager_1.default.CloseGuideUI(WindowCfgs_1.WindowCfgs.GuideUI);
            this.skipCall && this.skipCall.call(this.thisObj);
            GuideManager_1.default.ins.recentGuideId = null;
        }, this, true);
    }
    setData(args) {
        GuideManager_1.default.ins.noMask = false;
        var guideId = args[0];
        this.guideId = guideId;
        var guideData = GuideFunc_1.default.instance.getGuideInfo(guideId);
        ...
        if (this.panel.visible)
            this.text.text = TranslateFunc_1.default.instance.getTranslate(guideData.desc, "TranslateGuide", extra && extra.name);
        this.panel.top = NaN;
        ...
        switch (args[5]) {
            case GuideConst_1.default.GUIDE_TYPE_M_F: //有遮罩，有手指
                ...
                break;
            case GuideConst_1.default.GUIDE_TYPE_M: //有遮罩，无手指
                this.blackBg.visible = true;
                this.blackBgLeft.visible = true;
                this.blackBgRight.visible = true;
                this.blackBgBottom.visible = true;
                ...
                break;
            case GuideConst_1.default.GUIDE_TYPE_F: //无遮罩，有手指
                this.blackBg.visible = false;
                this.blackBgLeft.visible = false;
                this.blackBgRight.visible = false;
                this.blackBgBottom.visible = false;
                this.hand.visible = true;
                GuideManager_1.default.ins.noMask = true;
                break;
            case GuideConst_1.default.GUIDE_TYPE_RF: //无遮罩，有手指倒置
                this.blackBg.visible = false;
                this.blackBgLeft.visible = false;
                this.blackBgRight.visible = false;
                this.blackBgBottom.visible = false;
                ...
                GuideManager_1.default.ins.noMask = true;
                break;
            case GuideConst_1.default.GUIDE_TYPE_M_RF: //有遮，有手指倒置
                this.blackBg.visible = true;
                this.blackBgLeft.visible = true;
                this.blackBgRight.visible = true;
                this.blackBgBottom.visible = true;
                ...
                break;
            case GuideConst_1.default.GUIDE_TYPE_M_RIGHTF: //有遮，有手指右置
                this.blackBg.visible = true;
                this.blackBgLeft.visible = true;
                this.blackBgRight.visible = true;
                this.blackBgBottom.visible = true;
                ...
                break;
            case GuideConst_1.default.GUIDE_TYPE_NONE: //无遮罩，无手指
                this.blackBg.visible = false;
                this.blackBgLeft.visible = false;
                this.blackBgRight.visible = false;
                this.blackBgBottom.visible = false;
        ...
        LogsManager_1.default.echo("krma. alpha:" + alpha);
        ...
        if (this.guideId == GuideConst_1.default.GUIDE_2_202 || this.guideId == GuideConst_1.default.GUIDE_ROLEUNLOCK || this.guideId == GuideConst_1.default.GUIDE_12_1201) {
            //解锁新英雄特殊处理
            if (this.hitPos.y - 400 < 0) {
                this.hand.rotation = 180;
                if (this.guideId == GuideConst_1.default.GUIDE_12_1201) {
        ...
        else if (this.guideId == GuideConst_1.default.GUIDE_10003) {
        ...
        if (this.hand.visible) {
            this.addHandTween();
            this.timeCode = TimerManager_1.default.instance.add(this.addHandTween, this, 600);
        }
