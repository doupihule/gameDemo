...
/**技能相关 */
class SkillFunc extends BaseFunc_1.default {
    //处理用户配表相关接口.用静态方法
    //初始化 加载配表
    //存储所有配表
    getCfgsPathArr() {
        ...
        switch (Number(param[0])) {
            ...
            case 7:
                ...
                if (Number(param[1]) > 10000) {
                    value = GameUtils_1.default.getShowNum(Number(param[1]));
                }
                break;
            case 8:
            case 9:
...
exports.default = SkillFunc;
//# sourceMappingURL=SkillFunc.js.map